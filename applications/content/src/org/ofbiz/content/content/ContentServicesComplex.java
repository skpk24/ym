...
public class ContentServicesComplex {
    ...
    */
    ...
    public static Map<String, Object> getAssocAndContentAndDataResourceCacheMethod(Delegator delegator, String contentId, String mapKey, String direction,
        ...
        List<GenericValue> contentAssocsTypeFiltered = new ArrayList<GenericValue>();
        if (assocTypes != null && assocTypes.size() > 1) {
       ...
       // List<GenericValue> contentAssocDataResourceList = FastList.newInstance();
        List<GenericValue> contentAssocDataResourceList = new ArrayList<GenericValue>();
        ...
        while (it.hasNext()) {
            ...
            SimpleMapProcessor.runSimpleMapProcessor("component://content/script/org/ofbiz/content/ContentManagementMapProcessors.xml", "contentAssocOut", contentAssoc, contentAssocDataResourceView, new ArrayList(), locale);
            ...
            if (dataResource != null) {
                ...
                SimpleMapProcessor.runSimpleMapProcessor("component://content/script/org/ofbiz/content/ContentManagementMapProcessors.xml", "dataResourceOut", dataResource, contentAssocDataResourceView, new ArrayList(), locale);
            }
            //if (Debug.infoOn()) Debug.logInfo("contentAssocDataResourceView:" + contentAssocDataResourceView, module);
