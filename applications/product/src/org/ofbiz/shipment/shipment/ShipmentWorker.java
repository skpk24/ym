...
public class ShipmentWorker {
    ...
    public static List<Map<String, BigDecimal>> getPackageSplit(DispatchContext dctx, List<Map<String, Object>> shippableItemInfo, BigDecimal maxWeight) {
        ...
        List<Map<String, BigDecimal>> packages =new ArrayList<Map<String,BigDecimal>>();// FastList.newInstance();
                ...
                for (int z = 1; z <= totalQuantity.intValue(); z++) {
                    ...
                    for (long x = 0; x < pieces; x++) {
                        if (weight.compareTo(maxWeight) >= 0) {
                            Map<String, BigDecimal> newPackage = new HashMap<String, BigDecimal>(); //FastMap.newInstance();
                            ...
                            if (!addedToPackage) {
                                Map<String, BigDecimal> packageMap = new HashMap<String, BigDecimal>(); //FastMap.newInstance();
