...
public class ShipmentServices {
    ...
    public static Map<String, Object> createShipmentEstimate(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        List<GenericValue> storeAll = new ArrayList<GenericValue>();//FastList.newInstance();
    ...
    public static Map<String, Object> calcShipmentCostEstimate(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        List<GenericValue> estimateList = new ArrayList<GenericValue>();//FastList.newInstance();
        ...
        List<BigDecimal> shippableItemSizes =new ArrayList<BigDecimal>();// FastList.newInstance();
        Map<String, BigDecimal> shippableFeatureMap = new HashMap<String, BigDecimal>(); //FastMap.newInstance();
    ...
    public static Map<String, Object> fillShipmentStagingTables(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if ("SHIPMENT_PACKED".equals(shipmentStatusId)) {
            ...
            // to store list
            List<GenericValue> toStore =new ArrayList<GenericValue>();// FastList.newInstance();
    ...
    public static Map<String, Object> updateShipmentsFromStaging(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        Map<String, String> shipmentMap = new HashMap<String, String>(); //FastMap.newInstance();
        ...
        for (Map.Entry<String, String> entry: shipmentMap.entrySet()) {
            ...
            Map<String, Object> shipCtx = new HashMap<String, Object>(); //FastMap.newInstance();
    ...
    public static Map<String, Object> updatePurchaseShipmentFromReceipt(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            Map<String, BigDecimal> shippedCountMap = new HashMap<String, BigDecimal>(); //FastMap.newInstance();
            ...
            Map<String, BigDecimal> receivedCountMap = new HashMap<String, BigDecimal>(); //FastMap.newInstance();
    ...
    public static Map<String, Object> sendShipmentCompleteNotification(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        Map<String, Object> sendMap = new HashMap<String, Object>(); //FastMap.newInstance();
        GenericValue shipment = null ;
