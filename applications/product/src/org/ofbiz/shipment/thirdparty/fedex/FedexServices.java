    ...
    */
    public static Map<String, Object> fedexSubscriptionRequest(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            List<EntityCondition> postalAddressConditions =new ArrayList<EntityCondition>();// FastList.newInstance();
            ...
            List<EntityCondition> phoneNumberConditions =new ArrayList<EntityCondition>(); //FastList.newInstance();
            ...
            List<EntityCondition> faxNumberConditions =new ArrayList<EntityCondition>();// FastList.newInstance();
            ...
            List<EntityCondition> emailConditions =new ArrayList<EntityCondition>();// FastList.newInstance();
            ...
            Map<String, Object> subscriptionRequestContext = new HashMap<String, Object>(); //FastMap.newInstance();
    ...
    public static Map<String, Object> fedexShipRequest(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            Map<String, Object> shipRequestContext = new HashMap<String, Object>(); //FastMap.newInstance();
