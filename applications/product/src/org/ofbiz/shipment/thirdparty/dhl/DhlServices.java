...
public class DhlServices {
    ...
    public static Map<String, Object> handleDhlRateResponse(Document rateResponseDocument, Locale locale) {
        ...
        Map<String, Object> dhlRateCodeMap = new HashMap<String, Object>(); //FastMap.newInstance();
        ...
        */
        ...
        List<Map<String, String>> chargeList = new ArrayList<Map<String,String>>();//FastList.newInstance();
        if (UtilValidate.isNotEmpty(chargeNodeList)) {
            for (Element responseChargeElement: chargeNodeList) {
                Map<String, String> charge = new HashMap<String, String>(); //FastMap.newInstance();
