...
public class PickListServices {
    ...
    public static Map<String, Object> convertOrderIdListToHeaders(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if (orderHeaderList == null) {
            ...
            if (orderIdList != null) {
                List<EntityCondition> conditionList1 =new ArrayList<EntityCondition>(); //FastList.newInstance();
                List<EntityCondition> conditionList2 = new ArrayList<EntityCondition>();//FastList.newInstance();
