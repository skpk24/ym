...
public class ImportProductServices {
    ...
    public static Map<String, Object> productImportFromSpreadsheet(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        List<File> fileItems =new ArrayList<File>(); //FastList.newInstance();
        ...
        for (File item: fileItems) {
            ...
            List<Map<String, Object>> products =new ArrayList<Map<String,Object>>(); //FastList.newInstance();
            List<Map<String, Object>> inventoryItems =new ArrayList<Map<String,Object>>(); //FastList.newInstance();
