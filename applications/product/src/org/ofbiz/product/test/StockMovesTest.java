...
public class StockMovesTest extends OFBizTestCase {
    ...
    public void testStockMoves() throws Exception {
        Map<String, Object> fsmnCtx = new HashMap<String, Object>(); //FastMap.newInstance();
        Map<?,?> stockMoveHandled = null;
        List<?> warningList =new ArrayList();// FastList.newInstance();
        ...
        Map<String, Object> ppsmCtx = new HashMap<String, Object>(); //FastMap.newInstance();
