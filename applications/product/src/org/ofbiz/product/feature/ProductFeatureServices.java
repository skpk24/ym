...
public class ProductFeatureServices {
    ...
    public static Map<String, Object> getProductFeaturesByType(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            List<String> featureTypes =new ArrayList<String>();// FastList.newInstance();
    ...
    public static Map<String, Object> getAllExistingVariants(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        List<String> existingVariantProductIds =new ArrayList<String>(); //FastList.newInstance();
    ...
    public static Map<String, Object> getVariantCombinations(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            List<Map<String, Object>> oldCombinations =new ArrayList<Map<String,Object>>();// FastList.newInstance();
            ...
            for (Map.Entry<String, List<GenericValue>> entry: features.entrySet()) {
                ...
                List<Map<String, Object>> newCombinations =new ArrayList<Map<String,Object>>(); //FastList.newInstance();
                ...
                if (oldCombinations.size() > 0) {
                    ...
                    combinations =new ArrayList<Map<String,Object>>();// FastList.newInstance();
                }
                ...
                if (combinations.size()==0) {
                    for (GenericValue currentFeature: currentFeatures) {
                        if (currentFeature.getString("productFeatureApplTypeId").equals("SELECTABLE_FEATURE")) {
                            Map<String, Object> newCombination = new HashMap<String, Object>(); //FastMap.newInstance();
                            List<GenericValue> newFeatures =new ArrayList<GenericValue>();// FastList.newInstance();
                            List<String> newFeatureIds =new ArrayList<String>();// FastList.newInstance();
    ...
    public static Map<String, Object> getCategoryVariantProducts(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if ((memberProducts != null) && (memberProducts.size() > 0)) {
            ...
            Map<String, String> featuresByType = new HashMap<String, String>(); //FastMap.newInstance();
            ...
            List<GenericValue> products =new ArrayList<GenericValue>();//FastList.newInstance();  // final list of variant products
