                  ...
                  <table class="basic-table" cellspacing='0'>
                    ...
                    <#if (itemInfos?has_content)>
                      ...
                      <#-- <#list itemInfos as orderItem>  -->
                        ...
                        <tr>
                          <td>
                          	  <input type="checkbox" name="sel_${rowKey}" value="Y" id="${orderProduct.productId}"/>
                          	  <input type="hidden" id="rowKey_${orderProduct.productId}" value="${rowKey}"/>
                          	  <input type="hidden" id="orderItemQuantity_${orderProduct.productId}" value="${orderItemQuantity1}"/>
						  </td>
                          <td>${orderItem.orderItemSeqId}</td>
                          <td>
                              ${orderProduct.productId?default("N/A")}
                              <#if rowKey == 1>
                              <#assign productdemo=orderProduct.productId>
                              <#else>
                               <#assign productdemo=productdemo+" "+orderProduct.productId>
                               </#if>
                          ...
                          <td>&nbsp;</td>
                          <td align="center">
                            <input type="text" size="7" name="qty_${rowKey}" value="${inputQty}" id="qty_${rowKey}"/>
                          </td>
                          <td align="center">
