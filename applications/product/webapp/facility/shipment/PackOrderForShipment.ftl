    ...
    <div class="screenlet">
        ...
        <#--  <form name="selectOrderForm" method="post" action="<@ofbizUrl>PackOrder</@ofbizUrl>">
              ...
              <table cellspacing="0" class="basic-table">
                <tr>
                  <td width="10%" align="right"><span class="label">${uiLabelMap.ProductOrderId}</span></td>
                  <td width="1">&nbsp;</td>
                  <td width="20%">
        ...
        <#--  <form name="selectPicklistBinForm" method="post" action="<@ofbizUrl>PackOrder</@ofbizUrl>" style="margin: 0;">
              ...
              <table cellspacing="0" class="basic-table">
                <tr>
                  <td width="10%" align='right'><span class="label">${uiLabelMap.FormFieldTitle_picklistBinId}</span></td>
                  <td width="1">&nbsp;</td>
                  <td width="20%">
                  ...
                  <tr>
                    ...
                    <td valign="top">
                      ...
                      <#if shipmentCostEstimateForShipGroup?exists>
                          <#--<@ofbizCurrency amount=shipmentCostEstimateForShipGroup isoCode=orderReadHelper.getCurrency()?if_exists/>--><span class="WebRupee">&#8377;</span>&nbsp;${shipmentCostEstimateForShipGroup?if_exists}
                          <br/>
                      </#if>
                    </td>
                    <td>&nbsp;</td>
                ...
                <form name="singlePackForm" method="post" action="<@ofbizUrl>ProcessPackOrder</@ofbizUrl>">
                  ...
                  <table cellpadding="2" cellspacing="0" class="basic-table">
                    <tr>
                      <td>
                        <div>
                            <span class="label"><b>${uiLabelMap.ProductProductNumber}</b></span>
                      ...
                      <td>
                          <span class="label"><b>${uiLabelMap.ProductCurrentPackageSequence}</b></span>
