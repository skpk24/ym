    ...
    <div class="screenlet-body">
      ...
      <form method="post" action="<@ofbizUrl>sendconfirmationmail/${donePage}</@ofbizUrl>" name="sendConfirmationForm">
        ...
        <table class="basic-table" cellspacing='0'>
            <tr>
                <td class="label">${uiLabelMap.OrderSendConfirmationEmailSubject}&nbsp;</td>
                <td width="54%">
                ...
                <td class="label">${uiLabelMap.OrderSendConfirmationEmailSendTo}&nbsp;</td>
                <td width="54%">
                    <input type="text" size="40" name="sendTo" value="${sendTo}"/>
                </td>
                
            <tr>
                <td class="label">${uiLabelMap.OrderSendConfirmationEmailCCTo}&nbsp;</td>
                <td width="54%">
            ...
            <tr>
                <td class="label">${uiLabelMap.OrderSendConfirmationEmailBCCTo}&nbsp;</td>
                <td width="54%">
            ...
            <tr>
                <td class="label">${uiLabelMap.OrderSendConfirmationEmailContentType}&nbsp;</td>
                <td>${productStoreEmailSetting.contentType?default("text/html")}</td>
            </tr>
            
            <tr>
                <td class="label">${uiLabelMap.OrderSendConfirmationEmailBody}&nbsp;</td>
                <td width="54%">
      ...
      <a href="javascript:document.sendConfirmationForm.submit()" class="smallSubmit">${uiLabelMap.CommonSend}</a>
      </div>
      <br/>
    </div>
</div>
