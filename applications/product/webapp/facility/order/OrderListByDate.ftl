...
<div id="findOrdersList" class="screenlet">
  <div class="screenlet-title-bar">
    <div class="h3">
      ...
      <#if (listSize > 10)>
        <div class="createButton"><a class="buttontext" href="/ordermgr/control/orderlist?viewIndex=${state.getViewIndex() + 1}&amp;viewSize=${state.getViewSize()}&amp;filterDate=${filterDate?if_exists}">${uiLabelMap.CommonMore}</a></div>
      </#if>
    ...
    <#if orderHeaderList?has_content>
      ...
      <table class="basic-table hover-bar" cellspacing='1'>
        ...
        <#list orderHeaderList as orderHeader>
          ...
          <#if odr_tdy_date_str==curr_date_str>
