...
<div class="screenlet">
    ...
    <div class="screenlet-body">
       <table class="orderbasic-table" cellspacing='0'>
          <tr valign="bottom" class="header-row">
            <td width="30%"><b>${uiLabelMap.ProductProduct}</b></td>
            <td width="33%"><b>${uiLabelMap.CommonStatus}</b></td>
            <td width="5%"><b>${uiLabelMap.OrderQuantity}</b></td>
            <td width="10%" align="right"><b>${uiLabelMap.OrderUnitList}</b></td>
            <td width="10%" align="right"><b>${uiLabelMap.OrderAdjustments}</b></td>
            <td width="10%" align="right"><b>${uiLabelMap.OrderSubTotal}</b></td>
            <td width="2%">&nbsp;</td>
          </tr>
              ...
              <tr>
                ...
                <#else>
                  <td valign="top">
                    ...
                    <#if productId?exists>
                      <div>
                        <a href="/catalog/control/EditProduct?productId=${productId}" class="buttontext1" target="_blank">${uiLabelMap.ProductCatalog}</a>
                        <a href="/ecommerce/control/product?product_id=${productId}" class="buttontext1" target="_blank">${uiLabelMap.OrderEcommerce}</a>
                      ...
                      <#if unplannedQuantity < 0><#assign unplannedQuantity = 0></#if>
                        <div>
                            <table cellspacing="1" cellpadding="1" border="0">
                              <tr><td>
                                  <a class="buttontext1" href="/catalog/control/EditProductInventoryItems?productId=${productId}&amp;showAllFacilities=Y&amp;externalLoginKey=${externalLoginKey}" target="_blank">${uiLabelMap.ProductInventory}</a>
                              </td><td>&nbsp;</td></tr>
                              ...
                              <#if availableToPromiseByFacilityMap?exists && quantityOnHandByFacilityMap?exists && quantityOnHandByFacilityMap.get(productId)?exists && availableToPromiseByFacilityMap.get(productId)?exists>
                                ...
                                <tr><td>${uiLabelMap.ProductInInventory} [${facility.facilityName?if_exists}] ${uiLabelMap.ProductQoh}</td>
                                  <td>${qohQuantityByFacility} (${uiLabelMap.ProductAtp}: ${atpQuantityByFacility})</td></tr>
                              </#if>
                              <tr><td>${uiLabelMap.ProductInInventory} [${uiLabelMap.CommonAll} ${uiLabelMap.ProductFacilities}] ${uiLabelMap.ProductQoh}</td>
                                <td>${qohQuantity} (${uiLabelMap.ProductAtp}: ${atpQuantity})</td></tr>
                              <#if (product != null) && (product.productTypeId != null) && (product.productTypeId == "MARKETING_PKG_AUTO" || product.productTypeId == "MARKETING_PKG_PICK")>
                                <tr><td>${uiLabelMap.ProductMarketingPackageQOH}</td>
                                  <td>${mktgPkgQOH} (${uiLabelMap.ProductAtp}: ${mktgPkgATP})</td></tr>
                              </#if>
                              <tr><td>${uiLabelMap.OrderOnOrder}</td>
                                <td>${onOrderQuantity}</td></tr>
                              <tr><td>${uiLabelMap.OrderInProduction}</td>
                                <td>${inProductionQuantity}</td></tr>
                              <tr><td>${uiLabelMap.OrderUnplanned}</td>
                                <td>${unplannedQuantity}</td></tr>
                            </table>
                        </div>
                      </#if>
                    </#if>
