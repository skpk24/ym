    ...
    <div class="screenlet-body">
      <form method="post" name="findorder" action="<@ofbizUrl>orderlist</@ofbizUrl>">
        ...
        <table class="basic-table" cellspacing='0'>
          ...
          <tr>
          <br/>
            <td colspan="2" align="left" style="padding:5px 0 5px 174px;">
              <a href="javascript:document.findorder.submit()" class="smallSubmit">${uiLabelMap.CommonFind}</a>
            </td>
          </tr>
        </table>
      </form>
...
<#if hasPermission>
  <div id="findOrdersList" class="screenlet">
    ...
    <div class="mainsub"><@pagination/></div>
     <br class="clear"/>
    <div class="screenlet-body">
        <table class="basic-table hover-bar" cellspacing='1'>
          ...
          <#list orderHeaderList as orderHeader>
            ...
            <tr>
              ...
              <td>
                <a href="<@ofbizUrl>orderview?orderId=${orderHeader.orderId}</@ofbizUrl>" class="linkbuttontext">${orderHeader.orderId}</a>
              </td>
