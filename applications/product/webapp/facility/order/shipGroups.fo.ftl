...
<#list shipGroups as shipGroup>
  ...
  <fo:table table-layout="fixed" space-after.optimum="10pt"  font-size="10px">
    <fo:table-column/>
    <fo:table-column/>
    <fo:table-body>
      <fo:table-row>
        <fo:table-cell>
          <fo:block font-size="12pt">${uiLabelMap.OrderOrder} #${shipGroup.orderId}</fo:block>
        </fo:table-cell>
        <fo:table-cell>
      ...
      <fo:table-row>
        <fo:table-cell>
          <fo:block font-size="12pt">${uiLabelMap.OrderShipGroup} #${shipGroup.shipGroupSeqId}</fo:block>
        </fo:table-cell>
        <fo:table-cell>
          <fo:block text-align="right">
            <fo:instream-foreign-object>
  ...
  <fo:table table-layout="fixed" border="solid" font-size="10px">
    <fo:table-column column-width="proportional-column-width(2)"/>
    ...
    <fo:table-header>
      <fo:table-row font-weight="bold">
        <fo:table-cell background-color="#dfdfe0" height="20pt" display-align="center" border-top-style="solid" border-bottom-style="solid">
          <fo:block margin-left="5px">${uiLabelMap.ProductProduct}</fo:block>
        </fo:table-cell>
        <fo:table-cell background-color="#dfdfe0" height="20pt" display-align="center" border-top-style="solid" border-bottom-style="solid">
          <fo:block margin="5px">${uiLabelMap.CommonDescription}</fo:block>
        </fo:table-cell>
        <fo:table-cell background-color="#dfdfe0" text-align="right" height="20pt" display-align="center" border-top-style="solid" border-bottom-style="solid">
          <fo:block margin="5px">${uiLabelMap.OrderQuantityInShipGroup}</fo:block>
        </fo:table-cell>
        <fo:table-cell background-color="#dfdfe0" text-align="right" height="20pt" display-align="center" border-top-style="solid" border-bottom-style="solid">
          <fo:block>${uiLabelMap.OrderQuantityShipped}</fo:block>
        </fo:table-cell>
        <fo:table-cell   background-color="#dfdfe0" text-align="right" height="20pt" display-align="center" border-top-style="solid" border-bottom-style="solid">
          <fo:block margin="5px">${uiLabelMap.ProductOpenQuantity}</fo:block>
        </fo:table-cell>
      </fo:table-row>
    </fo:table-header>
    <fo:table-body>
      ...
      <fo:table-row>
        <fo:table-cell background-color="${rowColor}">
          <fo:block margin="5px">${line.product.productId}</fo:block>
        </fo:table-cell>
        <fo:table-cell background-color="${rowColor}">
          <fo:block margin="5px">${line.orderItem.itemDescription?if_exists}</fo:block>
        </fo:table-cell>
        <fo:table-cell background-color="${rowColor}">
          <fo:block margin="5px" text-align="right">${line.quantityInGroup?default(0)}</fo:block>
        </fo:table-cell>
        <fo:table-cell background-color="${rowColor}">
          <fo:block margin="5px" text-align="right">${line.quantityShipped?default(0)}</fo:block>
        </fo:table-cell>
        <fo:table-cell background-color="${rowColor}">
          <fo:block margin="5px" text-align="right">${line.quantityOpen?default(0)}</fo:block>
        </fo:table-cell>
