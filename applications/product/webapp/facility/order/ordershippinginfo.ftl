      ...
      <ul>
        <#if security.hasEntityPermission("FACILITY", "_CREATE", session) && ((orderHeader.statusId == "ORDER_APPROVED") || (orderHeader.statusId == "ORDER_SENT"))>
          ...
          <#if orderHeader.orderTypeId == "SALES_ORDER">
            ...
            <br/>
            <td><a href="javascript:document.quickShipOrder.submit()" class="ordershipping_buttontext2">${uiLabelMap.OrderQuickShipEntireOrder}</a></td>
          <#else> <#-- PURCHASE_ORDER -->
        ...
        <#if orderHeader.statusId != "ORDER_COMPLETED" && orderHeader.statusId != "ORDER_CANCELLED">
          <td><a href="<@ofbizUrl>OrderDeliveryScheduleInfo?orderId=${orderId}</@ofbizUrl>" class="ordershipping_buttontext2">${uiLabelMap.OrderViewEditDeliveryScheduleInfo}</a></td>
        </#if>
        <#if security.hasEntityPermission("ORDERMGR", "_RETURN", session) && orderHeader.statusId == "ORDER_COMPLETED">
          <#if returnableItems?has_content>
            ...
            <li><span class="label">Create Voucher : </span><select name="createVoucher" >
               <option value="N">N</option>
               <option value="Y">Y</option>
              </select>
            </form>
        	<a href="javascript:document.quickRefundOrder.submit()" class="buttontext">${uiLabelMap.OrderQuickRefundEntireOrder}</a><a href="javascript:document.quickreturn.submit()" class="buttontext">${uiLabelMap.OrderCreateReturn}</a>
        ...
        <#if orderHeader?has_content && orderHeader.statusId != "ORDER_CANCELLED">
          <#if orderHeader.statusId != "ORDER_COMPLETED">
            ...
            -->
            <td><a href="<@ofbizUrl>editOrderItems?${paramString}</@ofbizUrl>" class="ordershipping_buttontext2">${uiLabelMap.OrderEditItems}</a></td>
          </#if>
          <td><a href="<@ofbizUrl>loadCartFromOrder?${paramString}&amp;finalizeMode=init</@ofbizUrl>" class="ordershipping_buttontext2">${uiLabelMap.OrderCreateAsNewOrder}</a></td>
        </#if>
      </ul>
      <br/>
    </div>
  ...
  <div class="screenlet">
    <div class="screenlet-title-bar">
       ...
       <div class="h3">
         ...
         <a class="buttontext" href="<@ofbizUrl>shipGroups.pdf?orderId=${orderId}&amp;shipGroupSeqId=${shipGroup.shipGroupSeqId}</@ofbizUrl>">${uiLabelMap.OrderShipGroup} PDF</a>
       </div>
       &nbsp;${uiLabelMap.OrderShipmentInformation} - ${shipGroup.shipGroupSeqId}
       </div>
    ...
    <div class="screenlet-body">
            ...
            <#if shipGroup.contactMechId?has_content>
                <tr>
                    <td align="left" valign="top" width="15%" >
                        <span class="orderlabeltext">${uiLabelMap.OrderAddress}</span>
                    </td>
                ...
                <#if orderHeader.orderTypeId == "SALES_ORDER" && shipGroup.shipmentMethodTypeId?has_content>
                  <tr>
                    ...
                    <td align="left" valign="top" width="15%">
                        <span class="orderlabeltext">${uiLabelMap.CommonMethod}</span>
                    </td>
                    <td valign="top" width="80%">
                        ...
                        <div >
                            ...
                            "@" symbol.
                            -->
                            <select name="shipmentMethod" style="width:100px;">
      ...
      <table width="100%" border="0" cellpadding="1" cellspacing="1" class="basic-table">
        <#if shipGroup.supplierPartyId?has_content>
          ...
          <tr>
            <td align="left" valign="top" width="15%">
              <span class="orderlabeltext">${uiLabelMap.ProductDropShipment} - ${uiLabelMap.PartySupplier}</span>
            </td>
            <td valign="top" width="80%">
        ...
        <#if shipGroup.trackingNumber?has_content || orderShipmentInfoSummaryList?has_content>
          <tr>
            <td align="left" valign="top" width="15%">
              <span class="orderlabeltext">${uiLabelMap.OrderTrackingNumber}</span>
            </td>
            <td valign="top" width="80%">
        ...
        <#if shipGroup.maySplit?has_content && noShipment?default("false") != "true">
          <tr>
            <td align="left" valign="top" width="15%">
              <span class="orderlabeltext">${uiLabelMap.OrderSplittingPreference}</span>
            </td>
            <td valign="top" width="80%">
              <div>
                <#if shipGroup.maySplit?upper_case == "N">
                    <span class="ordersubtext" style="padding-left: 20px;">${uiLabelMap.FacilityWaitEntireOrderReady}</span>
                    <#if security.hasEntityPermission("ORDERMGR", "_UPDATE", session)>
                      <#if orderHeader.statusId != "ORDER_COMPLETED" && orderHeader.statusId != "ORDER_CANCELLED">
                        ...
                        <a href="javascript:document.allowordersplit_${shipGroup.shipGroupSeqId}.submit()" class="buttontext1" style="padding-left: 20px;">${uiLabelMap.OrderAllowSplit}</a>
                      </#if>
                    </#if>
                <#else>
        ...
        <#if shipGroup.shippingInstructions?has_content>
          <tr>
            <td align="right" valign="top" width="15%">
              <span class="orderlabeltext">&nbsp;${uiLabelMap.OrderInstructions}</span>
            </td>
            <td valign="top" width="80%">
        ...
        <#if shipGroup.isGift?has_content && noShipment?default("false") != "true">
          <tr>
            <td align="left" valign="top" width="15%">
              <span class="orderlabeltext">${uiLabelMap.OrderGift}</span>
            </td>
            <td valign="top" width="80%">
              <#if shipGroup.isGift?upper_case == "N">
               <span class="ordersubtext" style="padding-left: 20px;">${uiLabelMap.OrderThisOrderNotGift}</span>
               <#else>
                <span class="ordersubtext" style="padding-left: 20px;">${uiLabelMap.OrderThisOrderGift}</span>
               </#if>
            </td>
          </tr>
        </#if>
        <#if shipGroup.giftMessage?has_content>
          <tr>
            <td align="right" valign="top" width="15%">
              <span class="orderlabeltext">&nbsp;${uiLabelMap.OrderGiftMessage}</span>
            </td>
            <td valign="top" width="80%">
         ...
         <tr>
            <td align="right" valign="top" width="15%">
              <span class="orderlabeltext">&nbsp;${uiLabelMap.OrderShipAfterDate}<span>
            </td>
            <td valign="top" width="80%">
        ...
        <tr>
            <td align="right" valign="top" width="15%">
              <span class="orderlabeltext">&nbsp;${uiLabelMap.OrderShipBeforeDate}<span>
            </td>
            <td valign="top" width="80%">
       ...
       <#if shipGroupShipments?has_content>
          <tr>
            <td align="right" valign="top" width="15%">
              <span class="orderlabeltext">&nbsp;${uiLabelMap.FacilityShipments}<span>
            </td>
            <td valign="top" width="80%">
       ...
       <#if security.hasEntityPermission("ORDERMGR", "_UPDATE", session) && ((orderHeader.statusId == "ORDER_APPROVED") || (orderHeader.statusId == "ORDER_SENT"))>
         ...
         <tr>
            ...
            <br/>
             <#if orderHeader.orderTypeId == "SALES_ORDER">
               <#if !shipGroup.supplierPartyId?has_content>
                 <a href="/facility/control/PackOrder?facilityId=${storeFacilityId?if_exists}&amp;orderId=${orderId}&amp;shipGroupSeqId=${shipGroup.shipGroupSeqId}&amp;externalLoginKey=${externalLoginKey}" class="ordershipping_buttontext2">${uiLabelMap.OrderPackShipmentForShipGroup} [${shipGroup.shipGroupSeqId}]</a>
                 <a href="javascript:document.createShipment.submit()" class="ordershipping_buttontext2">${uiLabelMap.OrderNewShipmentForShipGroup}</a>
