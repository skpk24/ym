...
<fo:block text-align="left">
	<#if logoImageUrl?has_content><fo:external-graphic content-type="content-type:image/gif" src="<@ofbizContentUrl>${logoImageUrl}</@ofbizContentUrl>" overflow="hidden" height="30px" content-height="scale-to-fit"/></#if>
</fo:block>
...
<fo:block font-size="8px" text-align="left">
    ...
    <fo:list-block provisional-distance-between-starts="1in">
        ...
        <fo:list-item>
            ...
            <fo:list-item-body start-indent="26px">
