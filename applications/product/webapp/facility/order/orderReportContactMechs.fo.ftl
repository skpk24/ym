...
<#escape x as x?xml>
       ...
       <fo:block white-space-collapse="false" space-after="10pt"> </fo:block>
		<fo:block border-top="1px dotted black" space-after="10pt"></fo:block>
       <fo:table border-spacing="3pt" border-top="red" font-size="10px">
  ...
  <#-- payment info -->
       ...
       <fo:block white-space-collapse="false" space-after="10pt"> </fo:block>
		<fo:block border-top="1px dotted black" space-after="0"></fo:block>
