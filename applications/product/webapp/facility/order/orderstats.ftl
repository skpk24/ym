    ...
    <div class="screenlet-body">
        <table class="basic-table" cellspacing='0'>
          <tr class="label">
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td align="right"><b>${uiLabelMap.CommonToday}</b></td>
            <td align="right"><b>${uiLabelMap.OrderWTD}</b></td>
            <td align="right"><b>${uiLabelMap.OrderMTD}</b></td>
            <td align="right"><b>${uiLabelMap.OrderYTD}</b></td>
          </tr>
          <tr>
          <td colspan="2">&nbsp;</td>
          <td colspan="4"><hr/></td></tr>
          <tr>
            <td class="label"><b>${uiLabelMap.OrderOrdersTotals}</b></td>
            <td colspan="5">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td class="label"><b>${uiLabelMap.OrderOrdersItemCounts}</b></td>
            <td colspan="5">&nbsp;</td>
          </tr>
          <tr class="alternate-row">
            <td>&nbsp;</td>
          ...
          <tr><td colspan="6"><hr/></td></tr>
          <tr>
            <td class="label"><b>${uiLabelMap.OrderOrdersPending}</b></td>
            <td colspan="5">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr><td colspan="6"><hr/></td></tr>
          <tr>
            <td class="label"><b>${uiLabelMap.OrderStatusChanges}</b></td>
            <td colspan="5">&nbsp;</td>
          </tr>
          <tr class="alternate-row">
            <td>&nbsp;</td>
