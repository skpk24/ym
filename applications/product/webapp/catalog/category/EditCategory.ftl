        ...
        <form action="<@ofbizUrl>updateProductCategory</@ofbizUrl>" method="post" style="margin: 0;" name="productCategoryForm">
            ...
            <table cellspacing="0" class="basic-table">
                ...
                <#--tr>
                    ...
                    <td>&nbsp;</td>
                    <td width="74%">
                    	<textarea name="description" cols="60" rows="2"><#if productCategory?has_content>${(productCategory.description)?if_exists}</#if></textarea>
                    </td>
                </tr-->
                <tr>
                ...
                <tr>
                    ...
                    <td width="80%" colspan="4" valign="top">
                        ...
                        <input type="hidden" value="categorydetailmatrix" name="detailScreen"/>
                    </td>
                </tr>
                <tr>
                    <td width="26%" align="right" class="label">MAX UNIT</td>
                    <td>&nbsp;</td>
                    <td width="74%">
                        <input type="text" <#if productCategory?has_content>value="${productCategory.categoryMaxQuantity?if_exists}"</#if> name="categoryMaxQuantity" /></td>
                </tr>
                <tr>
