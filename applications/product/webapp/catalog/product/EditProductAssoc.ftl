    ...
    <div class="screenlet-body">
        <table cellspacing="0" class="basic-table">
            ...
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                ...
                <#assign fromdate = assocFromProduct.fromDate?if_exists/>
                <#if fromdate?has_content>
                	${fromdate?string("dd-MM-yyyy")?if_exists}&nbsp; 
                </#if>
                </td>
                ...
                <#assign thrudate = assocFromProduct.thruDate?if_exists/>
                <#if thrudate?has_content>
                ${thrudate?string("dd-MM-yyyy")?if_exists}&nbsp;
                </#if>
                </td>
