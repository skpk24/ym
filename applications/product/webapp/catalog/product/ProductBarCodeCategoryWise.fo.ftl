...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    <fo:layout-master-set>
        <fo:simple-page-master master-name="main" page-height="4in" page-width="8in"
                               margin-top="0.5in" margin-bottom="0.25in" margin-right="0.25in">
            <fo:region-body margin-top="0in"/>
            <fo:region-before extent="0in"/>
            <fo:region-after extent="0in"/>
        </fo:simple-page-master>
    </fo:layout-master-set>
       <#if requestAttributes.barcodeList?has_content>
			<#list requestAttributes.barcodeList as barCode>
			    <fo:page-sequence master-reference="main">
			        <fo:flow flow-name="xsl-region-body" font-family="Helvetica">
			            <fo:block text-align="center">
			                 ${barCode.barcodeName?if_exists}
			            </fo:block>
			            <fo:block text-align="center">
			                <fo:instream-foreign-object>
			                    <barcode:barcode xmlns:barcode="http://barcode4j.krysalis.org/ns"
			                                     message="${barCode.barcodeId?if_exists}">
			                        <barcode:code39>
			            ...
			            <fo:block text-align="center">
			                 ${barCode.barcodePrice?if_exists}
			            </fo:block>
