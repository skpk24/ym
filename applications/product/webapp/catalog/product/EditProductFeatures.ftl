...
<div class="screenlet">
  ...
  <#list productFeatureAndAppls as productFeatureAndAppl>
    ...
    <#if (productFeatureAndAppl.getTimestamp("thruDate"))?exists && Static["org.ofbiz.base.util.UtilDateTime"].nowTimestamp().after(productFeatureAndAppl.getTimestamp("thruDate"))> <#assign hasExpired = true></#if>
            ...
            <input type="hidden" name="productFeatureApplTypeId_o_${productFeatureAndAppl_index}" value="SELECTABLE_FEATURE" />
...
<div class="screenlet">
  ...
  <#list productFeatureCategories as productFeatureCategory>
      ...
      <input type="hidden" name="productFeatureGroupId" value="" />
  ...
  <#list productFeatureGroups as productFeatureGroup>
      ...
      <input type="hidden" name="productFeatureApplTypeId" value="SELECTABLE_FEATURE" />
