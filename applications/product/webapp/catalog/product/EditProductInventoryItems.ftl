               ...
               <#if showEmpty || (inventoryItem.inventoryItemTypeId?if_exists == "SERIALIZED_INV_ITEM" && inventoryItem.statusId?if_exists != "INV_DELIVERED")
                    ...
                    <#if curInventoryItemType?exists>
                        <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                            ...
                            <td>&nbsp;<#if inventoryItem.datetimeReceived?has_content>${(inventoryItem.datetimeReceived)?string("dd-MM-yyyy")?if_exists}</#if></td>
                            <td>&nbsp;<#if inventoryItem.expireDate?has_content>${(inventoryItem.expireDate)?string("dd-MM-yyyy")?if_exists}</#if></td>
                            ...
                            <td align="right"><#--<@ofbizCurrency amount=inventoryItem.unitCost isoCode=inventoryItem.currencyUomId/>--><span class="WebRupee">&#8377;</span>&nbsp;${inventoryItem.unitCost?if_exists}</td>
                            <td>
