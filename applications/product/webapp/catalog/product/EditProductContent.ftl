...
<h3>${uiLabelMap.ProductResultOfImageUpload}</h3>
    ...
    <form action="<@ofbizUrl>updateProductContent</@ofbizUrl>" method="post" style="margin: 0;" name="productForm">
        ...
        <table cellspacing="0" class="basic-table">
            ...
            <tr>
                <td width="20%" align="right" valign="top"><b>Ingredients</b></td>
                <td>&nbsp;</td>
                <td width="80%" colspan="4" valign="top">
                    <textarea cols="120" id="area1" rows="10" name="ingredients" >${StringUtil.wrapString(product.ingredients)?if_exists}</textarea>
                </td>
            </tr>
            <tr>
                <td width="20%" align="right" valign="top"></td>
                <td>&nbsp;</td>
                <td width="80%" colspan="4" valign="top"></td>
            </tr>
            <tr>
                <td width="20%" align="right" valign="top"><b>Nutritional Facts</b></td>
                <td>&nbsp;</td>
                <td width="80%" colspan="4" valign="top">
                	
                    <textarea cols="120" id="area2" rows="10" name="nutritionalFacts">${StringUtil.wrapString(product.nutritionalFacts)?if_exists}</textarea>
                </td>
            </tr>
            <tr>
