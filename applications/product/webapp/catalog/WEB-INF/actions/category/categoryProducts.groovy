...
productStore = org.ofbiz.product.store.ProductStoreWorker.getProductStore(request);
  allowBarCode = "N";  
	...
	{
		if(productStore.getString("allowBarCode") != null && productStore.getString("allowBarCode").equals("Y"))
			allowBarCode = "Y";
	}
	
context.allowBarCode = allowBarCode;
if(productStore != null)
