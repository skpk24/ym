...
partyRole = delegator.findByPrimaryKey("PartyRole", [partyId : partyId, roleTypeId : "SUPPLIER"]);
if (partyRole) {
    if ("SUPPLIER".equals(partyRole.roleTypeId)) {
        /** drop shipper or supplier **/
        porderRoleCollection = delegator.findByAnd("OrderRole", [partyId : partyId, roleTypeId : "SUPPLIER_AGENT"]);
...
orderRoleCollection = delegator.findByAnd("OrderRole", [partyId : partyId, roleTypeId : "PLACING_CUSTOMER"]);
