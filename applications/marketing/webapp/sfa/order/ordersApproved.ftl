...
<div id="findOrdersList" class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="paginationForm" method="post" action="<@ofbizUrl>ordersApproved</@ofbizUrl>">
		...
		<#if orderList?has_content>
			<div align="right">
				...
				<select name="serviceName" onchange="javascript:setServiceName(this);">
				   ...
				   <option value="<@ofbizUrl>massHoldApprovedOrders?hideFields=${requestParameters.hideFields?default("N")}${paramList}</@ofbizUrl>">${uiLabelMap.OrderHold}</option>
				   <option value="<@ofbizUrl>massCancelApprovedOrders?hideFields=${requestParameters.hideFields?default("N")}${paramList}</@ofbizUrl>">${uiLabelMap.OrderCancelOrder}</option>
				   <#--
