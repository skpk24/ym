...
<div id="findOrdersList" class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="paginationForm" method="post" action="<@ofbizUrl>ordersCreated</@ofbizUrl>">
		...
		<#if orderList?has_content>
			<div align="right">
				...
				<select name="serviceName" onchange="javascript:setServiceName(this);">
				   ...
				   <option value="<@ofbizUrl>massOrdersApprove?hideFields=${requestParameters.hideFields?default("N")}${paramList}</@ofbizUrl>">${uiLabelMap.OrderApproveOrder}</option>
				   ...
				   <option value="<@ofbizUrl>massOrdersCancel?hideFields=${requestParameters.hideFields?default("N")}${paramList}</@ofbizUrl>">${uiLabelMap.OrderCancelOrder}</option>
				   <#--
