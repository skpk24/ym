...
<div id="findOrdersList" class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="paginationForm" method="post" action="<@ofbizUrl>ordersHeld</@ofbizUrl>">
		...
		<#if orderList?has_content>
			<div align="right">
				...
				<select name="serviceName" onchange="javascript:setServiceName(this);">
				   ...
				   <option value="<@ofbizUrl>massApproveHoldOrders?hideFields=${requestParameters.hideFields?default("N")}${paramList}</@ofbizUrl>">${uiLabelMap.OrderApproveOrder}</option>
				   <option value="<@ofbizUrl>massCancelHoldOrders?hideFields=${requestParameters.hideFields?default("N")}${paramList}</@ofbizUrl>">${uiLabelMap.OrderCancelOrder}</option>
				</select>
