...
<div class="screenlet">
<div class="screenlet-title-bar"><h3>Merged Companies</h3></div>
  ...
  <table border="0" width="100%" >
    <tr>
      <td>
        <#if contactInfoList?has_content >
          ...
          <table  >
            ...
            <tr>
              ...
              <td width="20%"><input type="checkbox" name="useContactNum3" value="Y"/></td>
            </tr>
            <tr>
        ...
        <#else>
          <h3>No Companies selected to merge</h3>
        </#if>
      </td>
    </tr>
  </table>
