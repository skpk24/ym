...
teamTargetsReportList = delegator.findList("SalesTarget",EntityCondition.makeCondition("teamTypeId",EntityOperator.EQUALS,"INDIVIDUAL_TARGET"),null,null,null,false);
...
session.setAttribute("IndividualTargetsReportExcel_SFA_REPORTS", teamTargetsReportLists);
