                 ...
                 <#if shipping == true>
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <div>${uiLabelMap.OrderUpdateEmailAddress} ${uiLabelMap.PartyProfile}
                      <#--
                      <a href="<#if customerDetailLink?exists>${customerDetailLink}${shoppingCart.getPartyId()}" target="partymgr"
