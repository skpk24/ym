    ...
    <ul>
      ...
      <#if shoppingCart.getOrderType() == "SALES_ORDER">
        ...
        <#else>
          ...
          <#--<li><a href="<@ofbizUrl>finalizeOrder?finalizeMode=sales&amp;finalizeReqCustInfo=false&amp;finalizeReqShipInfo=false&amp;finalizeReqOptions=false&amp;finalizeReqPayInfo=false</@ofbizUrl>">${uiLabelMap.OrderFinalizeOrder}</a></li>-->
        </#if>
      </#if>
