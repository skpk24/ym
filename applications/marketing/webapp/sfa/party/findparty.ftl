    ...
    <div id="findPartyParameters" <#if hideFields != "N"> style="display:none" </#if> >
      ...
      <form method="post" name="lookupparty" action="<@ofbizUrl>findparty</@ofbizUrl>" class="basic-form">
        ...
        <table class="basic-table" cellspacing="0">
         ...
         <input type="hidden" name="groupName" value="${parameters.groupName?if_exists}"/>
         <input name="roleTypeId" type="hidden" value="CUSTOMER"/>
          <#--<tr>
...
<#list partyTypes as partyType>
           ...
           <input type="hidden" name="inventoryItemId" value="${parameters.inventoryItemId?if_exists}"/>
           <input type="hidden" name="serialNumber" value="${parameters.serialNumber?if_exists}"/>
           <input type="hidden" name="softIdentifier" value="${parameters.softIdentifier?if_exists}"/>
<#if extInfo == "P">
