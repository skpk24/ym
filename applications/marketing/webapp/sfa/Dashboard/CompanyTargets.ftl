<!DOCTYPE html >
<html>
<#if parameters.viewFTL?has_content && parameters.viewFTL?if_exists.equals("LeadTargets")>
...
<body>
    ...
    <tr>
        <canvas id="cmpnyByCntCVS" width="500" height="400">[No canvas support]</canvas>
        <canvas id="cmpnyByCntCVS1" width="500" height="500">[No canvas support]</canvas>
    </tr>
    </table>
...
<form method="post" name="lookuporder" id="lookuporder" >
    ...
    <p>
    <input type="hidden" id = "leadNameTeam"  value="${companyTargetsReportNames}" />
    <input type="hidden" id = "targetCostTeam"  value="${companyTargetsReportTargetCost}" />
    </p>
    </form>
</body>
</#if>
