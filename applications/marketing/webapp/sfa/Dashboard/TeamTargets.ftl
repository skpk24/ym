<!DOCTYPE html >
<html>
  <#if parameters.viewFTL?if_exists.equals("TeamTargets")>
...
<form method="post" name="lookuporder" id="lookuporder" >
    <p>
    <input type="hidden" id = "leadNameTeam"  value="${teamTargetsReportNames}" />
    <input type="hidden" id = "targetCostTeam"  value="${teamTargetsReportTargetCost}" />
    </p>
    </form>
</body>
</#if>
