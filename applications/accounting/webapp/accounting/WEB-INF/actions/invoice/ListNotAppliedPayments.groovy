...
// below line is commented becuause currCond is not working fine
//topCond = EntityCondition.makeCondition([partyCond, statusCond, currCond], EntityOperator.AND);
topCond = EntityCondition.makeCondition([partyCond, statusCond], EntityOperator.AND);
...
print "\n\n ########### not applied payment list ="+payments;
