...
<div class="screenlet">
  ...
  <div class="screenlet-body">
     ...
     <tr>
       <td align="left" valign="top" width="15%" class="orderlabeltext">Order Status History</td>
       <td colspan="2">
         ...
         <#if orderPaymentStatuses?has_content>
           ...
           <#list orderPaymentStatuses as orderPaymentStatus>
             ...
             <#if statusItem?has_content>
                ...
                <#if statusItem.get("description",locale)!="Not-Received">
          ...
          <#if !paymentMethod?has_content>
            ...
            <#else>
              <tr>
                ...
                <#if paymentMethodType.paymentMethodTypeId != "EXT_OFFLINE" && paymentMethodType.paymentMethodTypeId != "EXT_PAYPAL" && paymentMethodType.paymentMethodTypeId != "EXT_COD" && paymentMethodType.paymentMethodTypeId != "EXT_CREDIT">
                  <td width="60%">
                    <div>
                      <#if orderPaymentPreference.maxAmount?has_content>
                         <br/>${uiLabelMap.OrderPaymentMaximumAmount}: <@ofbizCurrency amount=orderPaymentPreference.maxAmount?default(0.00) isoCode=currencyUomId/>
                ...
                <#else>
                  <td align="right" width="60%">
                    <a href="<@ofbizUrl>receivepayment?${paramString}</@ofbizUrl>" class="buttontext1">Receive Payment</a>
                  </td>
                </#if>
                  <td width="10%">
                   <#if (!orderHeader.statusId.equals("ORDER_COMPLETED")) && !(orderHeader.statusId.equals("ORDER_REJECTED")) && !(orderHeader.statusId.equals("ORDER_CANCELLED"))>
          ...
          <tr>
            ...
            <td valign="top" colspan="2" width="60%">
              <#list invoices as invoice>
                <div>${uiLabelMap.CommonNbr}
                (<a href="/accounting/control/invoice.pdf?invoiceId=${invoice}" class="buttontext1" target="_blank">PDF---${invoice}</a>)
                
               <#-- <a href="/accounting/control/invoiceOverview?invoiceId=${invoice}&amp;externalLoginKey=${externalLoginKey}" target="_blank" class="buttontext1">${invoice}</a>-->
                </div>
              </#list>
            </td>
          </tr>
