...
under the License.
-->
<div class="button-bar button-style">
  <ul>
    <#if !(invoice.invoiceId)?has_content>
     <div style="position:absolute;right:25px;"><a href="<@ofbizUrl>newInvoiceForAp</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonCreateNew}</a></div>
    </#if>
    ...
    <#--
      ...
      <#--<#if (invoice.currencyUomId)?if_exists != defaultOrganizationPartyCurrencyUomId?if_exists>
        <li><a target="_BLANK" href="<@ofbizUrl>invoice.pdf?invoiceId=${invoice.invoiceId}&currency=${defaultOrganizationPartyCurrencyUomId}</@ofbizUrl>">${uiLabelMap.AccountingInvoicePDFDefaultCur}(${defaultOrganizationPartyCurrencyUomId?if_exists})</a></li>
      </#if>-->
      <#if invoice.statusId == "INVOICE_IN_PROCESS" || invoice.statusId == "INVOICE_RECEIVED">
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToApproved">
      ...
      <#if invoice.statusId == "INVOICE_IN_PROCESS">
        <#if invoice.invoiceTypeId == "PURCHASE_INVOICE" || invoice.invoiceTypeId == "CUST_RTN_INVOICE"> 
          <li>
            ...
            <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToReceived">
              <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
      ...
      <#if invoice.invoiceTypeId == "SALES_INVOICE" && (invoice.statusId == "INVOICE_IN_PROCESS" || invoice.statusId == "INVOICE_APPROVED")>
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToSent">
            <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
      ...
      <#if invoice.statusId == "INVOICE_IN_PROCESS" || invoice.statusId == "INVOICE_SENT" || invoice.statusId == "INVOICE_RECEIVED" || invoice.statusId == "INVOICE_APPROVED">
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToReady">
            <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
      ...
      <#if invoice.statusId == "INVOICE_READY">
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToPaid">
            <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
        ...
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToWriteoff">
            <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
      ...
      <#if invoice.statusId == "INVOICE_SENT" || invoice.statusId == "INVOICE_RECEIVED">
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToInProcess">
            <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
      ...
      <#if invoice.statusId == "INVOICE_SENT" || invoice.statusId == "INVOICE_RECEIVED" || invoice.statusId == "INVOICE_IN_PROCESS">
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_statusToCancelled">
            <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
      ...
      <#if invoice.invoiceTypeId == "SALES_INVOICE" || invoice.invoiceTypeId == "PURCHASE_INVOICE">
       <#--
        <li>
          ...
          <form method="post" action="<@ofbizUrl>setInvoiceStatusAp</@ofbizUrl>" onSubmit="javascript:submitFormDisableSubmits(this)" name="InvoiceSubTabBar_saveInvoiceAsTemplate">
            <input type="hidden" name="invoiceId" value="${invoice.invoiceId}"/>
