...
<#escape x as x?xml>
    ...
    <fo:table-header height="14px">
      <fo:table-row border-bottom-style="solid" border-bottom-width="thin" border-bottom-color="black">
        ...
        <fo:table-cell>
          <fo:block font-weight="bold" text-align="right">${uiLabelMap.AccountingUnitPrice}(<fo:external-graphic src="${contentUrl?if_exists?default('http://youmart.in')}/erptheme1/RSsymbol.png" overflow="hidden" height="7px"  content-height="scale-to-fit"/>)
          </fo:block>
        </fo:table-cell>
        <fo:table-cell>
          <fo:block font-weight="bold" text-align="right">${uiLabelMap.CommonAmount}(<fo:external-graphic src="${contentUrl?if_exists?default('http://youmart.in')}/erptheme1/RSsymbol.png" overflow="hidden" height="7px"  content-height="scale-to-fit"/>)</fo:block>
        </fo:table-cell>
      </fo:table-row>
    </fo:table-header>
    ...
    <fo:table-body font-size="10pt">
            ...
            <#if !isItemAdjustment>
                <fo:table-row height="14px" space-start=".15in">
                    ...
                    <fo:table-cell text-align="right">
                        ...
                        <fo:external-graphic src="${contentUrl?if_exists?default('http://youmart.in')}/erptheme1/RSsymbol.png" overflow="hidden" height="7px"  content-height="scale-to-fit"/>
                        ${invoiceItem.amount?if_exists}
                        </#if>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell text-align="right">
                        <fo:block>
                         <fo:external-graphic src="${contentUrl?if_exists?default('http://youmart.in')}/erptheme1/RSsymbol.png" overflow="hidden" height="7px"  content-height="scale-to-fit"/>
                         ${(Static["org.ofbiz.accounting.invoice.InvoiceWorker"].getInvoiceItemTotal(invoiceItem))?if_exists}
                          </fo:block>
                    </fo:table-cell>
                </fo:table-row>
            <#else>
                ...
                <fo:table-row height="14px" space-start=".15in">
                    ...
                    <fo:table-cell text-align="right" number-columns-spanned="3">
                        <fo:block> 
                        <fo:external-graphic src="${contentUrl?if_exists?default('http://youmart.in')}/erptheme1/RSsymbol.png" overflow="hidden" height="7px"  content-height="scale-to-fit"/>
                        ${(Static["org.ofbiz.accounting.invoice.InvoiceWorker"].getInvoiceItemTotal(invoiceItem))?if_exists} </fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </#if>
        </#list>
        ...
        <fo:table-row>
           ...
           <fo:table-cell text-align="right" border-top-style="solid" border-top-width="thin" border-top-color="black">
              <fo:block><fo:external-graphic src="${contentUrl?if_exists?default('http://youmart.in')}/erptheme1/RSsymbol.png" overflow="hidden" height="7px"  content-height="scale-to-fit"/>${invoiceNoTaxTotal?if_exists}</fo:block>
           </fo:table-cell>
        </fo:table-row>
        <fo:table-row height="7px">
           <fo:table-cell number-columns-spanned="5">
        ...
        <fo:table-row height="14px">
           ...
           <fo:table-cell text-align="right" border-top-style="solid" border-top-width="thin" border-top-color="black">
              <fo:block>
                 <fo:external-graphic src="${contentUrl?if_exists?default('http://youmart.in')}/erptheme1/RSsymbol.png" overflow="hidden" height="7px"  content-height="scale-to-fit"/>${invoiceNoTaxTotal?if_exists}
              </fo:block>
           </fo:table-cell>
        </fo:table-row>
    </fo:table-body>
