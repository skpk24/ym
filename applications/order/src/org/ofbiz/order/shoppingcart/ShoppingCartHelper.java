...
public class ShoppingCartHelper {
    ...
    public Map<String, Object> addToCart(String catalogId, String shoppingListId, String shoppingListItemSeqId, String productId,
      ...
      //  Map<String, GenericValue> additionalFeaturesMap = FastMap.newInstance();
        ...
        String recipientMobileNum=(String) context.get("recipientMobile");
        String recipientEmailId=(String) context.get("recipientemail");
        String recipientName=(String) context.get("recipientName");
        String recipientMessage=(String) context.get("message");
        ...
        try {
            ...
            if (productId != null) {
                       ...
                       itemId = cart.addOrIncreaseItem(productId, amount, quantity, reservStart, reservLength,
                                                ...
                                                catalogId, configWrapper, itemType, itemGroupNumber, pProductId, recipientMobileNum, recipientEmailId, recipientName, recipientMessage, dispatcher);
            ...
            ShoppingCartItem item1 = cart.findCartItem(itemId);
            if(item1 != null)
            {
            	item1.setProductCategoryId(productCategoryId);
            	String url = ShoppingCartEvents.getProductIndexUrl(delegator, dispatcher, item1.getProductId(), item1.getProductId());
            	item1.setProductUrl(url);
            }
    ...
    public Map<String, Object> addToCartFromOrder(String catalogId, String orderId, String[] itemIds, boolean addAll, String itemGroupNumber) {
        ...
        if(!orderHelper.isOrderContainsGiftCard()){
            result = ServiceUtil.returnError("Cannot add gift card items from order,please create new gift card");
        	 return result;
        }
        ...
        if (itemIter != null && itemIter.hasNext()) {
            while (itemIter.hasNext()) {
                ...
                if (UtilValidate.isNotEmpty(productId) && orderItem.get("quantity") != null) {
                    ...
                    try {
                    	 if("Y".equalsIgnoreCase(orderItem.getString("isPromo"))) continue;
                        this.cart.addOrIncreaseItem(UtilValidate.isNotEmpty(aggregatedProdId) ? aggregatedProdId :  productId, amount, orderItem.getBigDecimal("quantity"),
                                null, null, null, null, null, null, null, catalogId, configWrapper, orderItemTypeId, itemGroupNumber, null, null, null, null, null, dispatcher);
                        noItems = false;
                    } catch (CartItemModifyException e) {
                        errorMsgs.add(e.getMessage());
                    } catch (ItemNotFoundException e) {
            ...
            if (UtilValidate.isNotEmpty(quantStr)) {
                ...
                if (quantity.compareTo(BigDecimal.ZERO) > 0) {
                    ...
                    try {
                        ...
                        this.cart.addOrIncreaseItem(productId, null, quantity, null, null, null, null, null, null, null, catalogId, null, null, itemGroupNumberToUse, originalProductId, null, null, null, null, dispatcher);
                    } catch (CartItemModifyException e) {
                ...
                if (UtilValidate.isNotEmpty(quantStr)) {
                    ...
                    if (quantity.compareTo(BigDecimal.ZERO) > 0) {
                        ...
                        try {
                            ...
                            int index = this.cart.addOrIncreaseItem(productId, null, quantity, null, null, null, requirement.getTimestamp("requiredByDate"), null, null, null, catalogId, null, null, itemGroupNumber, null, null, null, null, null, dispatcher);
            ...
            if (quantity != null && quantity.compareTo(BigDecimal.ZERO) > 0) {
                try {
                    this.cart.addOrIncreaseItem(productCategoryMember.getString("productId"),
                            ...
                            catalogId, null, null, itemGroupNumber, null, null, null, null, null, dispatcher);
