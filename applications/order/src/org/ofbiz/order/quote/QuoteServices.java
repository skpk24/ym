...
public class QuoteServices {
    ...
    public static Map<String, Object> sendQuoteReportMailCustom(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        String attacheY = (String) context.get("attacheY");
       ...
       // Map<String, Object> sendMap = FastMap.newInstance();
        ...
        if("Y".equals(attacheY))
        {
            ...
            sendMap.put("attachmentName", "Qoute_"+quoteId+".pdf");
