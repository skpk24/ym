        ...
        <div class="screenlet-body">
            <table class="order-items basic-table" cellspacing='0'>
			   ...
			   <#assign keys = sampleMap1.keySet()/>
			    <#list keys as key>
			    <tr><td colspan="${numColumns?if_exists}"> 
                                                ...
                                                <div class="screenlet-body">
                                                    <table cellspacing="0" cellpadding="0" border="0">
                                                        ...
                                                        <#--<#if (product != null) && (product.productTypeId != null) && Static["org.ofbiz.entity.util.EntityTypeUtil"].hasParentType(delegator, "ProductType", "productTypeId", product.productTypeId, "parentTypeId", "MARKETING_PKG")>-->
                                                         <#if product?exists && product.productTypeId?has_content  && Static["org.ofbiz.entity.util.EntityTypeUtil"].hasParentType(delegator, "ProductType", "productTypeId", product.productTypeId, "parentTypeId", "MARKETING_PKG")>
                                                            <tr>
                ...
                <#-- subtotal -->
                <#assign ordPromo = delegator.findByAnd("OrderProductPromoCode", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId", orderId)) >
                <tr>
                    <td align="right" colspan="4">
                        <span class="label">Promo Code Used : </span>
                    </td>
                    <td align="right" nowrap="nowrap">
                        <#if ordPromo?has_content && ordPromo?size == 1><strong>${ordPromo.get(0).productPromoCodeId?if_exists}</strong></#if>
                    </td>
                    <td colspan="2">&nbsp;</td>
                </tr>
                <tr>
