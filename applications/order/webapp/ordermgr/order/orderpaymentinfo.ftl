       ...
       <#list orderPaymentPreferences as orderPaymentPreference>
         ...
         <#list payments as payment>
           ...
           <tr>
             ...
             <td><#--<@ofbizCurrency amount=payment.amount?if_exists/>--><span class="WebRupee">&#8377;</span>&nbsp;${payment.amount?if_exists}</td>
         ...
         <#if orderPaymentStatuses?has_content>
           <#list orderPaymentStatuses as orderPaymentStatus>
             ...
             <#if statusItem?has_content>
                <div>
                  ${statusItem.get("description",locale)} - ${orderPaymentStatus.statusDatetime?default("0000-00-00 00:00:00")?string("dd-MM-yyyy")}
                  &nbsp;
                ...
                <tr>
                  <td align="right" valign="top" width="29%">
                    ...
                    <#if orderPaymentPreference.maxAmount?has_content>
                       <br />${uiLabelMap.OrderPaymentMaximumAmount}: <#--<@ofbizCurrency amount=orderPaymentPreference.maxAmount?default(0.00) isoCode=currencyUomId/>--><span class="WebRupee">&#8377;</span>&nbsp;${orderPaymentPreference.maxAmount?default(0.00)?if_exists}
                    </#if>
                    </div>
                  </td>
                  <td width="1%">&nbsp;</td>
                    ...
                    <#if gatewayResponses?has_content>
                      <div>
                        ...
                        <#list gatewayResponses as gatewayResponse>
                          ...
                          ${gatewayResponse.transactionDate?string("dd-MM-yyyy")}
                          <#--<@ofbizCurrency amount=gatewayResponse.amount isoCode=currencyUomId/>--><span class="WebRupee">&#8377;</span>&nbsp;${gatewayResponse.amount?if_exists}<br />
          ...
          <tr>
            <td align="right" valign="top" width="29%">
              ...
              <div>&nbsp;<span class="label">${uiLabelMap.AccountingBillingAccount}</span>&nbsp;
                  ...
                  <br />${uiLabelMap.OrderPaymentMaximumAmount}: <#--<@ofbizCurrency amount=billingAccountMaxAmount?default(0.00) isoCode=currencyUomId/>--><span class="WebRupee">&#8377;</span>&nbsp;${billingAccountMaxAmount?default(0.00)?if_exists}
                  </#if>
                  </div>
            </td>
            <td width="1%">&nbsp;</td>
