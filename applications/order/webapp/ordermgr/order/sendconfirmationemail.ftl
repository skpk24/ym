      ...
      <form method="post" action="<@ofbizUrl>sendconfirmationmail/${donePage}</@ofbizUrl>" name="sendConfirmationForm">
        ...
        <table class="basic-table" cellspacing='0'>
            ...
            <tr>
                ...
                <td>
                    <textarea name="body" id="body" rows="30" cols="80" encode-output="true">${screens.render(productStoreEmailSetting.bodyScreenLocation?default(""))}</textarea>
       		 </td>
            </tr>
        </table>
      </form>
