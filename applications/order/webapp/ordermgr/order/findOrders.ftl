              ...
              <tr>
                ...
                <td align='left'>
                  <select name='orderStatusId'>
                    ...
                    <option value="${currentStatus.statusId}">${currentStatus.get("description")}</option>
                ...
                <td align='left'>
                  <select name="shipmentMethod">
                    ...
                    <#list carrierShipmentMethods as carrierShipmentMethod>
                      <#assign shipmentMethodType = carrierShipmentMethod.getRelatedOne("ShipmentMethodType")?if_exists>
