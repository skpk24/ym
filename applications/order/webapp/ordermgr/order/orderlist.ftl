          ...
          <tr>
            ...
            <td nowrap="nowrap">
                <div>
                    ...
                    <input type="checkbox" name="viewcompleted" value="Y" <#if state.hasStatus('viewcompleted')>checked="checked"</#if> />In Transit
                    ...
                    <input type="checkbox" name="viewcancelled" value="Y" <#if state.hasStatus('viewcancelled')>checked="checked"</#if> />${uiLabelMap.CommonCancelled}
                       <input type="checkbox" name="viewfulfilled" value="Y" <#if state.hasStatus('viewfulfilled')>checked="checked"</#if> />Order Fulfilled
                </div>
            </td>
          </tr>
          <tr>
    ...
    <div class="screenlet-body">
        <table class="basic-table hover-bar" cellspacing='0'>
          ...
          <#list orderHeaderList as orderHeader>
            ...
            <tr>
              <td><#if orderHeader.orderDate?has_content>${orderHeader.orderDate?string("dd-MM-yyyy")}</#if></td>
              <td>
              ...
              <td>${orderHeader.getRelatedOneCache("StatusItem").get("description")}</td>
              <#if state.hasFilter('filterInventoryProblems') || state.hasFilter('filterAuthProblems') || state.hasFilter('filterPOsOpenPastTheirETA') || state.hasFilter('filterPOsWithRejectedItems') || state.hasFilter('filterPartiallyReceivedPOs')>
              <td>
