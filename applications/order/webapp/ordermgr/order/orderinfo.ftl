...
<div class="screenlet order-info">
    <div class="screenlet-title-bar">
        <ul>
            ...
            <#elseif currentStatus.statusId == "ORDER_PACKED">
              <li><a href="javascript:document.OrderDispatch.submit()">Dispatch Order</a>
              <form name="OrderDispatch" method="post" action="<@ofbizUrl>changeOrderStatus/orderview</@ofbizUrl>">
                <input type="hidden" name="statusId" value="ORDER_DISPATCHED"/>
                <input type="hidden" name="workEffortId" value="${workEffortId?if_exists}"/>
                <input type="hidden" name="orderId" value="${orderId?if_exists}"/>
                <input type="hidden" name="partyId" value="${assignPartyId?if_exists}"/>
                <input type="hidden" name="roleTypeId" value="${assignRoleTypeId?if_exists}"/>
            ...
            <#if setOrderCompleteOption || (currentStatus?has_content && currentStatus.statusId == "ORDER_DISPATCHED")>
        ...
        <table class="basic-table" cellspacing='0'>
            ...
            <tr>
              ...
              <td valign="top" width="80%"<#if currentStatus.statusCode?has_content> class="${currentStatus.statusCode}"</#if>>
                <span class="current-status">${uiLabelMap.OrderCurrentStatus}: ${currentStatus.get("description")}</span>
                <#if orderHeaderStatuses?has_content>
                  ...
                  <#list orderHeaderStatuses as orderHeaderStatus>
                    ...
                    <div>
                      ${loopStatusItem.get("description")} - ${orderHeaderStatus.statusDatetime?default("0000-00-00 00:00:00")?string("dd-MM-yyyy")}
                      &nbsp;
            ...
            <tr>
              ...
              <td width="5%">&nbsp;</td>
              <td valign="top" width="80%"><#if orderHeader.orderDate?has_content>${orderHeader.orderDate?string("dd-MM-yyyy")}</#if></td>
            </tr>
            <tr><td colspan="3"><hr /></td></tr>
            <tr>
            ...
            <#if orderItem.cancelBackOrderDate?exists>
              ...
              <tr>
                ...
                <td width="5%">&nbsp;</td>
                <td valign="top" width="80%">${orderItem.cancelBackOrderDate?string("dd-MM-yyyy")?if_exists}</td>
              </tr>
            </#if>
            ...
            <#if orderHeader.pinId?has_content>
            <tr><td colspan="3"><hr /></td></tr>
            <tr>
              <td align="right" valign="top" width="15%" class="label">&nbsp;Happy Code</td>
              <td width="5%">&nbsp;</td>
              <td valign="top" width="80%">${orderHeader.pinId}</td>
            </tr>
            </#if>
