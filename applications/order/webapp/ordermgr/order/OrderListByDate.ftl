...
<div id="findOrdersList" class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      <li class="h3">${uiLabelMap.OrderOrderReceivedOn} <#--${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(filterDate)}--><#if filterDate?has_content>${filterDate?string("dd-MM-yyyy")?if_exists}</#if></li>
