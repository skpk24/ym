...
<script src="/images/prototype.js" language="JavaScript" type="text/javascript">$.noConflict();</script>
...
function submitForm(form, mode, value) {
    if (mode == "DN") {
        ...
        var done = true;
        try{
        var ajaxCount  = document.getElementById("AjaxCount").value;
        for(var  i = 0;i<ajaxCount;i++){
        if(document.getElementById("dayOption_"+i).checked){
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr valign="top">
                     ...
                     <#list shippingContactMechList as shippingContactMech>
                       ...
                       <tr>
                         <td valign="top" width="1%">
                           <input type="radio" name="shipping_contact_mech_id"   id="shipping_contact_mech_id_${count}" value="${shippingAddress.contactMechId}" onclick="javascript:submitForm(document.checkoutInfoForm, 'SA', null);"<#if shoppingCart.getShippingContactMechId()?default("") == shippingAddress.contactMechId> checked="checked"</#if>/>
                         </td>
      ...
      <td height="100%" width="350">
        <div class="screenlet" style="height: 100%;width:326px;">
            <div class="screenlet-title-bar shipwidth">
                <#if shipping == true>
            ...
            <div class="screenlet-body" style="height: 100%;">
                <table width="100%" cellpadding="1" border="0" cellpadding="0" cellspacing="0" class="backslot">
                    <tr><td colspan="5" class="slotTopHdrDate">Booking</td></tr>
                  
                    <tr><td class="dayoption">Delivery Date:</td>
						<td><input id="deliveryDate" type="text"  name="deliveryDate"  size="10" maxlength="10"/>    
						      <script type="text/javascript">
					            ...
					            jQuery("#deliveryDate").datepicker({
					              ...
					              function validate(deliveryDate){ 
						                ...
						                for(var i=0;i<count;i++){
							                 ...
							                 var mechId =  document.getElementById("shipping_contact_mech_id_"+i).value;
							                 new Ajax.Updater("slots","<@ofbizUrl>slotSelectionForBackOffice</@ofbizUrl>", {parameters:{deliveryDate: deliveryDate,mechId:mechId}});
							                 entered = true;
							                 break;
							                 }
						               }  
                   ...
                   <tr>
                    ...
                    <input type="hidden" name="shipping_method" value="NO_SHIPPING"/>
                    <input type="hidden" name="may_split" value="true"/>
        ...
        <div class="screenlet" style="height: 100%;">
            ...
            <div class="screenlet-body" style="height: 100%;">
                <table width="100%" cellpadding="1" cellspacing="0" border="0">
                  ...
                  <tr>
                    <td width="1%">
                      <input type="radio" name="checkOutPaymentId" value="CASH" <#if "CASH" == checkOutPaymentId>checked="checked"</#if>/>
                    </td>
                    <td width="50%">
                      <span>Cash</span>
                    </td>
                  ...
                  <#if productStorePaymentMethodTypeIdMap.EXT_COMPLIMENTARY?exists>
                  <tr>
                    <td width="1%">
                      <input type="radio" name="checkOutPaymentId" value="EXT_COMPLIMENTARY" <#if "EXT_COMPLIMENTARY" == checkOutPaymentId>checked="checked"</#if>/>
                    </td>
                    <td width="50%">
                  ...
                  <#if productStorePaymentMethodTypeIdMap.EXT_CREDIT?exists>
                  <tr>
                    <td width="1%">
                      <input type="radio" name="checkOutPaymentId" value="EXT_CREDIT" <#if "EXT_CREDIT" == checkOutPaymentId>checked="checked"</#if>/>
                    </td>
                    <td width="50%">
                      <span>Credit</span>
                    </td>
                  ...
                  <#if productStorePaymentMethodTypeIdMap.EXT_AP?exists>
                  <tr>
                    <td width="1%">
                      <input type="radio" name="checkOutPaymentId" value="EXT_AP" <#if "EXT_AP" == checkOutPaymentId>checked="checked"</#if>/>
                    </td>
                    <td width="50%">
                  ...
                  <tr>
                    <td width="1%">
                      <input type="radio" name="checkOutPaymentId" value="PERSONAL_CHECK" <#if "PERSONAL_CHECK" == checkOutPaymentId>checked="checked"</#if>/>
                    </td>
                    <td width="50%">
