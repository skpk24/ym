...
<div class="screenlet">
    ...
    <div class="screenlet-body">
            ...
            <p><strong>${uiLabelMap.CommonTotal}</strong>: <#--<@ofbizCurrency amount=shoppingCart.getGrandTotal() isoCode=currencyUomId/>--><span class="WebRupee">&#8377;</span>&nbsp;${shoppingCart.getGrandTotal()?if_exists}</p>
    </div>
</div>
<br />
