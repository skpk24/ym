        ...
        <ul>    
            <#list shoppingCart.getProductPromoUseInfoIter() as productPromoUseInfo>
                <li>
                    ...
                    <#if (productPromoUseInfo.totalDiscountAmount != 0)> - ${uiLabelMap.CommonTotalValue} <#--<@ofbizCurrency amount=(-1*productPromoUseInfo.totalDiscountAmount) isoCode=shoppingCart.getCurrency()/>--><span class="WebRupee">&#8377;</span>&nbsp;${(-1*productPromoUseInfo.totalDiscountAmount)?if_exists}</#if>
                </li>
