      ...
      <#if partyContent?has_content>
        <table class="basic-table" cellspacing="0">
          <#list partyContent as pContent>
            <#assign findPftMap = Static["org.ofbiz.base.util.UtilMisc"].toMap("contentId", pContent.contentId)>
            <#assign content = delegator.findByPrimaryKey("Content", findPftMap)>
            <#assign contentType = content.getRelatedOneCache("ContentType")?if_exists>
            ...
            <tr>
              ...
              <#assign findPerMap = Static["org.ofbiz.base.util.UtilMisc"].toMap("partyId",pContent.partyId)>
              <#assign person = delegator.findByPrimaryKey("Person", findPerMap)>
              ...
              <td class="button-col">
                ...
                <form name="removePartyContent_${pContent_index}" method="post" action="<@ofbizUrl>removePartyContent/viewprofile</@ofbizUrl>">
                  ...
                  <input type="hidden" name="partyContentTypeId" value="${pContent.partyContentTypeId?if_exists}" />
