...
<#if partyList?exists>
  ...
  <#if partyList?has_content>
    <table class="basic-table hover-bar" cellspacing="0" border="1">
    ...
    <#list partyList as partyRow>
      ...
      <#else>
        ...
        <td class="button-col align-float">
          ...
          <td width="25%"><a href="/ordermgr/control/checkinits?partyId=${partyRow.partyId + externalKeyParam}">${uiLabelMap.OrderNewOrder}</a></td>
