...
public class ContactMechWorker {
    ...
    public static List<Map<String, Object>> getPartyContactMechValueMaps(Delegator delegator, String partyId, boolean showOld, String contactMechTypeId) {
        List<Map<String, Object>> partyContactMechValueMaps = new  ArrayList<Map<String, Object>>();//FastList.newInstance();
        ...
        try {
            ...
            if (contactMechTypeId != null) {
                List<GenericValue> tempColTemp = new  ArrayList<GenericValue>();//FastList.newInstance();
        ...
        for (GenericValue partyContactMech: allPartyContactMechs) {
            ...
            if (contactMech != null) {
                Map<String, Object> partyContactMechValueMap = new HashMap<String, Object>(); //FastMap.newInstance();
    ...
    public static List<Map<String, Object>> getFacilityContactMechValueMaps(Delegator delegator, String facilityId, boolean showOld, String contactMechTypeId) {
        List<Map<String, Object>> facilityContactMechValueMaps = new  ArrayList<Map<String, Object>>();//FastList.newInstance();
        ...
        for (GenericValue facilityContactMech: allFacilityContactMechs) {
            ...
            if (contactMech != null) {
                Map<String, Object> facilityContactMechValueMap = new HashMap<String, Object>(); //FastMap.newInstance();
    ...
    public static List<Map<String, GenericValue>> getOrderContactMechValueMaps(Delegator delegator, String orderId) {
        List<Map<String, GenericValue>> orderContactMechValueMaps = new  ArrayList<Map<String, GenericValue>>();//FastList.newInstance();
        ...
        for (GenericValue orderContactMech: allOrderContactMechs) {
            ...
            if (contactMech != null) {
                Map<String, GenericValue> orderContactMechValueMap = new HashMap<String, GenericValue>(); // FastMap.newInstance();
    ...
    public static Collection<Map<String, GenericValue>> getWorkEffortContactMechValueMaps(Delegator delegator, String workEffortId) {
        Collection<Map<String, GenericValue>> workEffortContactMechValueMaps = new  ArrayList<Map<String, GenericValue>>();//FastList.newInstance();
        ...
        for (GenericValue workEffortContactMech: allWorkEffortContactMechs) {
            ...
            if (contactMech != null) {
                Map<String, GenericValue> workEffortContactMechValueMap = new HashMap<String, GenericValue>(); //FastMap.newInstance();
    ...
    public static void getContactMechAndRelated(ServletRequest request, String partyId, Map<String, Object> target) {
        ...
        if (contactMechTypeId != null) {
            ...
            Collection<GenericValue> purposeTypes = new  ArrayList<GenericValue>();//FastList.newInstance();
    ...
    public static GenericValue getFacilityContactMechByPurpose(Delegator delegator, String facilityId, List<String> purposeTypes) {
        ...
        for (String purposeType: purposeTypes) {
            ...
            for (GenericValue facilityContactMechPurpose: facilityContactMechPurposes) {
                ...
                conditionList = new  ArrayList<EntityCondition>();//FastList.newInstance();
                conditionList.add(EntityCondition.makeCondition("facilityId", facilityId));
    ...
    public static List<Map<String, Object>> getPartyPostalAddresses(ServletRequest request, String partyId, String curContactMechId) {
        Delegator delegator = (Delegator) request.getAttribute("delegator");
        List<Map<String, Object>> postalAddressInfos = new  ArrayList<Map<String, Object>>();//FastList.newInstance();
        ...
        for (GenericValue partyContactMech: allPartyContactMechs) {
            ...
            if (contactMech != null && "POSTAL_ADDRESS".equals(contactMech.getString("contactMechTypeId")) && !contactMech.getString("contactMechId").equals(curContactMechId)) {
                Map<String, Object> postalAddressInfo = new HashMap<String, Object>(); //FastMap.newInstance();
    ...
    public static Map<String, Object> getCurrentPostalAddress(ServletRequest request, String partyId, String curContactMechId) {
        Delegator delegator = (Delegator) request.getAttribute("delegator");
        Map<String, Object> results = new HashMap<String, Object>(); //FastMap.newInstance();
    ...
    public static boolean isCompanyAddress(GenericValue postalAddress, String companyPartyId) {
        ...
        List<GenericValue> postalAddresses = new  ArrayList<GenericValue>();//FastList.newInstance();
        try {
    ...
    public static GenericValue getOrderContactMechValue(Delegator delegator, String orderId, String contactMechPurposeTypeId) {
        List<GenericValue> allOrderContactMechs = null;
    	GenericValue orderContactMech = null;

        try {
            allOrderContactMechs = delegator.findByAnd("OrderContactMech", UtilMisc.toMap("orderId", orderId, "contactMechPurposeTypeId", contactMechPurposeTypeId), UtilMisc.toList("contactMechPurposeTypeId"));
            
            if(allOrderContactMechs != null)
            orderContactMech = EntityUtil.getFirst(allOrderContactMechs);
            
        } catch (GenericEntityException e) {
            Debug.logWarning(e, module);
        }

        if (orderContactMech == null) return orderContactMech;
    ...
    public static String getOrderEmailContactMech(GenericDelegator delegator, String orderId) {
    	String emailId = null;
        List<GenericValue> OrderEmailContactMechs = null;

        try {
        	OrderEmailContactMechs = delegator.findByAnd("OrderContactMech", UtilMisc.toMap("orderId", orderId, "contactMechPurposeTypeId", "ORDER_EMAIL"), UtilMisc.toList("contactMechPurposeTypeId"));
        } catch (GenericEntityException e) {
            Debug.logWarning(e, module);
        }

        if (OrderEmailContactMechs == null) return null;

        for (GenericValue orderContactMech: OrderEmailContactMechs) {
            GenericValue contactMech = null;
            ...
            if (contactMech != null) {
            	emailId = (String) contactMech.get("infoString");
            }
        }
