...
public class WorkEffortServices {
    ...
    public static Map<String, Object> getWorkEffortAssignedEventsForRole(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        if (validWorkEfforts == null) {
            validWorkEfforts =new ArrayList<GenericValue>(); //FastList.newInstance();
        }
    ...
    public static Map<String, Object> getWorkEffortAssignedEventsForRoleOfAllParties(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        try {
            List<EntityExpr> conditionList =new ArrayList<EntityExpr>();// FastList.newInstance();
    ...
    public static Map<String, Object> getWorkEffortAssignedTasks(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        Map<String, Object> result = new HashMap<String, Object>(); //FastMap.newInstance();
        if (validWorkEfforts == null) validWorkEfforts =new ArrayList<GenericValue>();// FastList.newInstance();
    ...
    public static Map<String, Object> getWorkEffortAssignedActivities(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        if (userLogin != null && userLogin.get("partyId") != null) {
            try {
                List<EntityExpr> constraints = new ArrayList<EntityExpr>();//FastList.newInstance();
    ...
    public static Map<String, Object> getWorkEffortAssignedActivitiesByRole(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        Map<String, Object> result = new HashMap<String, Object>(); //FastMap.newInstance();
        if (roleWorkEfforts == null) roleWorkEfforts = new ArrayList<GenericValue>();//FastList.newInstance();
    ...
    public static Map<String, Object> getWorkEffortAssignedActivitiesByGroup(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        Map<String, Object> result = new HashMap<String, Object>(); // FastMap.newInstance();
        if (groupWorkEfforts == null) groupWorkEfforts = new ArrayList<GenericValue>();//FastList.newInstance();
    ...
    public static Map<String, Object> getWorkEffort(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        Map<String, Object> resultMap = new HashMap<String, Object>(); //FastMap.newInstance();
                ...
                for (Map<String, Object>calendarEntry: calendarEntries) {
                    ...
                    if (calEntryRange.intersectsRange(dateRange) && !(calEntryRange.end().equals(dateRange.start()) || calEntryRange.start().equals(dateRange.end()))) {
                        ...
                        if (calendarEntryByDateRangeList == null) {
                            calendarEntryByDateRangeList = new ArrayList<Map<String,Object>>();//FastList.newInstance();
                        }
    ...
    private static List<EntityCondition> getDefaultWorkEffortExprList(String calendarType, Collection<String> partyIds, String workEffortTypeId, List<EntityCondition> cancelledCheckAndList) {
        List<EntityCondition> entityExprList = new ArrayList<EntityCondition>();//FastList.newInstance();
        if (cancelledCheckAndList != null) {
            entityExprList.addAll(cancelledCheckAndList);
        }
        List<EntityExpr> typesList = new ArrayList<EntityExpr>();//FastList.newInstance();
...
//        }
        ...
        List<Map<String, Object>> periods =new ArrayList<Map<String,Object>>(); //FastList.newInstance();
        if (validWorkEfforts != null) {
            List<DateRange> periodRanges =new ArrayList<DateRange>(); //FastList.newInstance();
            ...
            for (DateRange periodRange : periodRanges) {
                List<Map<String, Object>> curWorkEfforts =new ArrayList<Map<String,Object>>(); //FastList.newInstance();
                Map<String, Object> entry = new HashMap<String, Object>(); //FastMap.newInstance();
                for (GenericValue workEffort : validWorkEfforts) {
                    ...
                    if (periodRange.intersectsRange(weRange)) {
                        Map<String, Object> calEntry = new HashMap<String, Object>(); //FastMap.newInstance();
    ...
    public static Map<String, Object> getProductManufacturingSummaryByFacility(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        Map<String, Map<String, Object>> summaryInByFacility = new HashMap<String, Map<String, Object>>(); //FastMap.newInstance();
        Map<String, Map<String, Object>> summaryOutByFacility = new HashMap<String, Map<String, Object>>(); //FastMap.newInstance();
        try {
            //
            // Information about the running production runs that are going
            // to produce units of productId by facility.
            //
            List<EntityCondition> findIncomingProductionRunsConds =new ArrayList<EntityCondition>();// FastList.newInstance();
            ...
            List<EntityCondition> findIncomingProductionRunsStatusConds = new ArrayList<EntityCondition>();//FastList.newInstance();
            ...
            for (GenericValue incomingProductionRun: incomingProductionRuns) {
                ...
                if (quantitySummary == null) {
                    quantitySummary = new HashMap<String, Object>(); //FastMap.newInstance();
                ...
                if (incomingProductionRunList == null) {
                    incomingProductionRunList =new ArrayList<GenericValue>(); //FastList.newInstance();
            ...
            //
            List<EntityCondition> findOutgoingProductionRunsConds =new ArrayList<EntityCondition>(); //FastList.newInstance();
            ...
            List<EntityCondition> findOutgoingProductionRunsStatusConds =new ArrayList<EntityCondition>();// FastList.newInstance();
            ...
            for (GenericValue outgoingProductionRun: outgoingProductionRuns) {
                ...
                if (outgoingProductionRunList == null) {
                    outgoingProductionRunList =new ArrayList<GenericValue>();// FastList.newInstance();
    ...
    public static Map<String, Object> removeDuplicateWorkEfforts(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        if (eli != null) {
            ...
            resultList =new ArrayList<GenericValue>(); //FastList.newInstance();
