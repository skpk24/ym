...
public class ICalRecurConverter implements TemporalExpressionVisitor {
    ...
    protected List<DateListProperty> incDateList =new ArrayList<DateListProperty>(); //FastList.newInstance();
    protected List<DateListProperty> exDateList =new ArrayList<DateListProperty>();// FastList.newInstance();
    protected List<RRule> incRuleList = new ArrayList<RRule>();//FastList.newInstance();
    protected List<ExRule> exRuleList = new ArrayList<ExRule>();//FastList.newInstance();
    ...
    protected class VisitorState {
        ...
        public List<Recur> inclRecurList =new ArrayList<Recur>();// FastList.newInstance();
        public List<Recur> exRecurList = new ArrayList<Recur>();//FastList.newInstance();
