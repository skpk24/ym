...
<#assign requestVal = reqUri.substring(lastIndexVal) />
  <div id="ecom-header">
    <div id="left">
      <#if sessionAttributes.overrideLogo?exists>
        <a href="<@ofbizUrl>home</@ofbizUrl>"><img src="<@ofbizContentUrl>${sessionAttributes.overrideLogo}</@ofbizContentUrl>" alt="Logo"/></a>
      <#elseif catalogHeaderLogo?exists>
        <a href="<@ofbizUrl>home</@ofbizUrl>"><img src="<@ofbizContentUrl>${catalogHeaderLogo}</@ofbizContentUrl>" alt="Logo"/></a>
      <#elseif layoutSettings.VT_HDR_IMAGE_URL?has_content>
        <a href="<@ofbizUrl>home</@ofbizUrl>"><img src="<@ofbizContentUrl>${layoutSettings.VT_HDR_IMAGE_URL.get(0)}</@ofbizContentUrl>" alt="Logo"/></a>
      </#if>
    </div>
    <div id="right">
     <ul id="right-links">
  ...
  <div id="ecom-header-bar">
    <div style="float:left; border-right:1px solid #fff;"><a href="<@ofbizUrl>home</@ofbizUrl>"><img src="/images/home-icon.jpg" alt="home"></a></div>
  <ul id="left-links">	
  	<#assign catalogCol = Static["org.ofbiz.product.catalog.CatalogWorker"].getCatalogIdsAvailable(request)?if_exists>
				...
				<#if (catalogCol?size > 0)>
				    ...
				    <#list catalogCol as catalogId>
				    	<li <#if currentCatalogId?has_content && currentCatalogId == catalogId>class="selected"</#if>>
				        <form name="CATEGORY_${catalogId?if_exists}${counter?if_exists}" method="post" action="<@ofbizUrl>main</@ofbizUrl>">
					    	...
					    	<a href="#" onclick="document.CATEGORY_${catalogId}${counter}.submit()" > ${thisCatalogName}</a>
				        </form>
				        </li>
				    </#list>
				</#if>	
  </ul>
  <div style="float:right; border-left:1px solid #fff;"><a href="<@ofbizUrl>view/showcart</@ofbizUrl>"><img src="/images/cart.jpg" alt="cart"></a></div>
    <#--<ul id="left-links">
      <#if userLogin?has_content && userLogin.userLoginId != "anonymous">
        <li id="header-bar-logout"><a href="<@ofbizUrl>logout</@ofbizUrl>">${uiLabelMap.CommonLogout}</a></li>
      <#else/>
