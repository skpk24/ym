...
<div style="margin-bottom:10px;"><img src="/images/banners/youmart-savings.jpg"/></div>
...
<div class="inner-content">
 ...
 <#if party?exists>
 <div class="Shopcar_pageHead">Welcome to the family of YouMart</div>

	<p style="margin-top:0px !important; text-align:justify">You are our esteemed citizen of YouMart to enjoy & avail our unique Loyalty Program which enables you to avail additional discounts every time you come and shop with us.
	These discounts are credited based on the points you accumulate as and when you shop. Every rupee that you spend through us will qualify for accumulating points and you can redeem these points which is credited in value in your YouMart Savings Credit Balance. You can presently view your balance credit below, to enable you to redeem while shopping.
	</p>
	<p style="margin-top:0px !important; text-align:justify">
	You can redeem the below value when you reach the Mode of Payment stage where you will be prompted to choose the value & proceed for the final payment.
	</p>
	<br/>
	<p style="margin-top:0px !important; text-align:justify">
	Enjoy Shopping! Enjoy Saving! As you get value for every rupee that you spend.
	</p>
 </div>
 
 <div style="clear:both;"> </div>
  <div class="Shopcar_pageHead">YouMart Savings</div>
  <div class="screenlet-body">
  <div style="padding:10px;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
        <td align="right" width="240px">You have <span style="color:#06509B; font-weight:bold;"><#if totalloyaltyPoints?exists>${totalloyaltyPoints?if_exists}<#elseif leftloyaltyPoints?exists>${leftloyaltyPoints?if_exists}<#else> 0 </#if></span> Savings Points.</td>
          <#--td align="right">You have ${totalloyaltyPoints?if_exists} Savings Points.</td-->
       </tr>
       <tr>
         <td style="text-align:left !important;">
          <div class="boxlink" style="float:left;padding:5px 0!important;">
            <input type="hidden" name="balanceAmount"  id="balanceAmount" value="<#if leftBalance?exists>${leftBalance?if_exists}<#else>0</#if>" />
         
            <p>YouMart Saving Credit Balance:<span style="color:#06509B; font-weight:bold;"><span class="WebRupee">&#8377;</span>&nbsp;<#if leftBalance?exists>${leftBalance?if_exists}<#else>0</#if></span></p> 
     ...
     <#-- </tr>
      ...
      <#list partyContactMechValueMaps as partyContactMechValueMap>
        ...
        <#assign partyContactMech = partyContactMechValueMap.partyContactMech?if_exists />
          ...
          <tr>
          <#if (i>2) && contactMech.contactMechTypeId?if_exists = "POSTAL_ADDRESS">
      ...
      <tr>
         ...
         <td align="right" valign="top" style="text-align:right;">
              <a href="<@ofbizUrl>modifycontactmech?emailcontactMechId=${emailcontactId}&amp;postalcontactMechId=${postalcontactId}&amp;telecontactMechId=${telecontactId}</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonUpdate}</a>
...
${screens.render('component://ecommerce/widget/ecomclone/CustomerScreens.xml#SubscriptionSummary')}  -->
    ...
    <div class="inner-content">
	<h3 class="Shopcar_pageHead">YouMart Savings Program</h3>
	<div style="clear:both;"></div>
	<p style="margin-top:0px !important; text-align:justify">YouMart Savings is a unique Loyalty Program where you can accumulate points as you shop & these points are valued which can be redeemed in your future purchases.</p>
	<p style="margin-top:0px !important; text-align:justify">You automatically enter into the Savings Program as soon as you register with YouMart and place the first order with us. You need not fill any additional form, just need to update the information online while you register.</p>
	<p style="margin-top:0px !important; text-align:justify">We follow a unique process of accumulating points and valuing those points to enable you to redeem them as and when required.</p>
	<div style="clear:both;"></div>
	<h3 class="Shopcar_pageHead">Redemption</h3>
	<p style="margin-top:0px !important;">Customers will be able to redeem their credit in any of the following methods:<p>
	<ul class="point">
		<li>Avail direct discount in their future billings by redeeming the savings points.</li>
		<li>Pick products from YouMart site upto to the value outstanding in your account.</li>
		<li>Pick from the list of special products we arrange for redemption.</li>
		<#--<li>Issue Savings vouchers and use them in other selected outlets - Coming soon!!! </li>-->	
	</ul>
	<p>You can access your Savings Program to check your balance and value added by clicking 'Your Account' on the main tab.</p>
</div>
</#if>
