...
<#else>
    <#if !eftAccount?exists>
      ...
      <form method="post" class="creditcard-info" action="<@ofbizUrl>createEftAccount?DONE_PAGE=${donePage}</@ofbizUrl>" name="editeftaccountform" style="margin: 0;">
    <#else>
      <h1>${uiLabelMap.PageTitleEditEFTAccount}</h1>
      <form method="post" class="creditcard-info" action="<@ofbizUrl>updateEftAccount?DONE_PAGE=${donePage}</@ofbizUrl>" name="editeftaccountform" style="margin: 0;">
        <input type="hidden" name="paymentMethodId" value="${paymentMethodId}" />
    </#if>
    <a href="<@ofbizUrl>${donePage}</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonCancelDone}</a>
    <a href="javascript:document.editeftaccountform.submit()" class="buttontext">${uiLabelMap.CommonSave}</a><br/><br/>

    <table width="90%" border="0" cellpadding="2" cellspacing="0" style="font-size:12px;">
    <tr>
      <td width="20%" align="right" valign="top" ><div class="efttext">${uiLabelMap.AccountingNameOnAccount}</div></td>
      <td width="80%">
        <input type="text" class="inputBox" size="30" maxlength="60" name="nameOnAccount" value="${eftAccountData.nameOnAccount?if_exists}" />
      *</td>
    </tr>
    <tr>
      <td width="20%" align="right" valign="top"><div class="efttext">${uiLabelMap.AccountingCompanyNameOnAccount}</div></td>
      <td width="80%">
    ...
    <tr>
      <td width="20%" align="right" valign="top"><div class="efttext">${uiLabelMap.AccountingBankName}</div></td>
      <td width="80%">
        <input type="text" class="inputBox" size="30" maxlength="60" name="bankName" value="${eftAccountData.bankName?if_exists}" />
      *</td>
    </tr>
    <tr>
      <td width="20%" align="right" valign="top"><div class="efttext">${uiLabelMap.AccountingRoutingNumber}</div></td>
      <td width="80%">
        <input type="text" class="inputBox" size="10" maxlength="30" name="routingNumber" value="${eftAccountData.routingNumber?if_exists}" />
      *</td>
    </tr>
    <tr>
      <td width="20%" align="right" valign="top"><div class="efttext">${uiLabelMap.AccountingAccountType}</div></td>
      <td width="80%">
    ...
    <tr>
      <td width="20%" align="right" valign="top"><div class="efttext">${uiLabelMap.AccountingAccountNumber}</div></td>
      <td width="80%">
        <input type="text" class="inputBox" size="20" maxlength="40" name="accountNumber" value="${eftAccountData.accountNumber?if_exists}" />
      *</td>
    </tr>
    <tr>
      <td width="20%" align="right" valign="top"><div class="efttext">${uiLabelMap.CommonDescription}</div></td>
      <td width="80%">
    ...
    <tr>
      <td width="20%" align="right" valign="top"><div class="efttext">${uiLabelMap.PartyBillingAddress}</div></td>
      <td width="80%">
        ...
        <#if curPostalAddress?exists>
          <tr>
            ...
            <td valign="top" width="80%">
              <div class="efttext"><b>${uiLabelMap.PartyUseCurrentAddress}:</b></div>
              ...
              <div class="efttext">(${uiLabelMap.CommonUpdated}:&nbsp;${(curPartyContactMech.fromDate.toString())?if_exists})</div>
              <#if curPartyContactMech.thruDate?exists><div class="efttext"><b>${uiLabelMap.CommonDelete}:&nbsp;${curPartyContactMech.thruDate.toString()}</b></div></#if>
            </td>
          </tr>
        <#else>
           <#-- <tr>
          ...
          <#list postalAddressInfos as postalAddressInfo>
            ...
            <tr>
              ...
              <td valign="top" width="80%">
                ...
                <div class="efttext">(${uiLabelMap.CommonUpdated}:&nbsp;${(partyContactMech.fromDate.toString())?if_exists})</div>
                <#if partyContactMech.thruDate?exists><div class="efttext"><b>${uiLabelMap.CommonDelete}:&nbsp;${partyContactMech.thruDate.toString()}</b></div></#if>
              </td>
            </tr>
          </#list>
