...
<div class="screenlet">
  ...
  <a href="javascript:document.getElementById('changepasswordform').submit()" class="buttontext">[${uiLabelMap.CommonSave}]</a><br/><br/>
  <div class="screenlet-body">
    ...
    <a href="<@ofbizUrl>authview/${donePage}</@ofbizUrl>" class="buttontext">[${uiLabelMap.CommonGoBack}]</a>
    <a href="javascript:document.getElementById('changepasswordform').submit()" class="buttontext">[${uiLabelMap.CommonSave}]</a>
  </div>
</div>