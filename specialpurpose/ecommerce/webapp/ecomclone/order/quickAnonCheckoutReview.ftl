...
<#if cart?exists && 0 < cart.size()>
  ${screens.render("component://ecommerce/widget/ecomclone/OrderScreens.xml#quickAnonOrderHeader")}
  <br />
  <div id="orderItemsSection">${screens.render("component://ecommerce/widget/ecomclone/OrderScreens.xml#orderitems")}</div>
