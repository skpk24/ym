...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        <table width="100%" cellspacing="0" cellpadding="1" border="0" style="border:1px solid #cccccc; padding:10px;">
                  ...
                  <div class="tabletext">
                    <#if cartLine.getProductId()?exists>
                      ...
                      <#list itemShipGroups.entrySet() as group>
                        <div class="tabletext"  style="margin-top:5px;">
...
<table style="width:100%;">
  <tr valign="top">
    <td>
      &nbsp;<a href="<@ofbizUrl>view/showcart</@ofbizUrl>" class="buttontext">${uiLabelMap.OrderBacktoShoppingCart}</a>
    </td>
    <td align="right" style="text-align:right;">
      <a href="<@ofbizUrl>view/checkoutpayment</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonContinue}</a>
    </td>
  </tr>
</table>
