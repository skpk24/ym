   ...
   if (paymentMethodTypeOption.length > 0){
      if(paymentMethodTypeOption == "CREDIT_CARD"){
        ...
        jQuery.ajax({
     	...
     	jQuery.ajax({
            url: "<@ofbizUrl>quickAnonEnterExtCod?paymentMethodTypeId=CREDIT_CARD</@ofbizUrl>",
            type: "POST",
            success: function(data) {
            alert(data)
                document.getElementById("paymentInfoSection").innerHTML = data;
        ...
        document.setPaymentInformation.action = "<@ofbizUrl>quickAnonEnterExtCod</@ofbizUrl>";
       //document.setPaymentInformation.action = "/ecommerce/control/quickAnonEnterCreditCard";
      } 
       ...
       // document.setPaymentInformation.paymentMethodTypeId.value = "EXT_COD";
        //document.getElementById("paymentInfoSection").innerHTML = "";
       // document.setPaymentInformation.action = "<@ofbizUrl>quickAnonEnterExtCod</@ofbizUrl>";
        ...
        document.setPaymentInformation.paymentMethodTypeId.value = "EXT_DIRECPAY";
        document.getElementById("paymentInfoSection").innerHTML = "";
        document.setPaymentInformation.action = "<@ofbizUrl>quickAnonEnterExtCod</@ofbizUrl>";
      } else {
...
<div class="screenlet">
    ...
    <div class="screenlet-body">
          ...
          <table width="100%" border="0" cellpadding="1" cellspacing="0">
              ...
              <tr>
                 <td width="160" align="left" valign="top"><div class="tableheadtext">${uiLabelMap.OrderSelectPaymentMethod}</div></td>
                 <td colspan="2" align="left">
                   <select name="paymentMethodTypeOptionList" class="selectBox" style="width:179px;"  onchange="javascript:getPaymentInformation();">
                     ...
                     <#if productStorePaymentMethodTypeIdMap.EXT_DIRECPAY?exists>
                       <option value="EXT_DIRECPAY" <#if (parameters.paymentMethodTypeId?default("") == "EXT_DIRECPAY")> selected="selected"</#if>>${uiLabelMap.OrderPaymentDirectPay}</option>
                     </#if>
                   </select>
                 </td>
              </tr>
