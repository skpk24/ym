...
<style>
ul, li{ list-style-type:none; margin:0; padding:0; font-size:12px !important;}
 </style>
...
<tr>
	<td v-align="top">
	<div style="float:left; border-right:1px solid #cccccc; padding-right:10px; padding-left:6px; ">
					 <div class="screenlet" >
					  <#if orderItemShipGroups?has_content>
					    <#--<h3>${uiLabelMap.OrderShippingInformation} Shipping Address</h3>-->
					    <#-- shipping address -->
					    <b style="font-size:12px !important;">Your Order will be delivered to this address</b>
					    <#assign groupIdx = 0>
					    <#list orderItemShipGroups as shipGroup>
					      ...
					      <ul style="margin:0px; padding:0px;list-style-type:none;">
				           ...
				           <li>
				            <ul style="margin:0px; padding:0px; margin-bottom:10px; list-style-type:none;">
				              ...
				              <li>
				                ...
				                ${shippingAddress.city}-${shippingAddress.postalCode?if_exists}<#if shippingStateGeo?has_content></br> ${shippingStateGeo.geoName?capitalize?if_exists}</#if> 
				              </li>
				              <li>
				 ...
				 <#-- orderid --> 
				  <div class="screenlet">
				    ...
				    <#if orderHeader?has_content>
				    <#--${uiLabelMap.OrderOrder}--><b style="font-size:12px !important; ">Order ID : ${orderHeader.orderId}</b> 
				    <#if (orderHeader.statusId)?if_exists == "ORDER_REJECTED">
  ...
  <div style="float:left; margin-left:10px;">
				    ...
				    <div class="screenlet">
						<b style="font-size:12px !important;">Your Delivery Slot</b> </br>
						 <#if orderHeader?has_content>
					...
					<div class="screenlet">
					  <#if paymentMethods?has_content || paymentMethodType?has_content || billingAccount?has_content>
					    <#-- order payment info -->
					    <#--${uiLabelMap.AccountingPaymentInformation}--> <b style="font-size:12px !important;">Your Method of Payment</b>
