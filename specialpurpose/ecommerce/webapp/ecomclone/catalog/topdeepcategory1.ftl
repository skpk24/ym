											    		   ...
											    		   <#if subCatList?has_content>
											    			<ul class="maindropdown">
											      				<#list subCatList as subCat>
											          				...
											          				<#--<li class="subcat" style="position:relative;"><a href="<@ofbizUrl>category?category_id=${subCat.productCategoryId?if_exists}&CURRENT_CATALOG_ID=${currentCatalogId}</@ofbizUrl>">${subCat.categoryName}</a>-->
											          			
											          				<li class="subcat" style="position:relative;"><a href="${Static["org.ofbiz.product.category.CatalogUrlServlet"].makeCatalogUrl(request, "",subCat.productCategoryId, CategoryListSub2.productCategoryId)}?CURRENT_CATALOG_ID=${currentCatalogId}">${subCat.categoryName}</a>
											          				<#assign subCatLists1 = Static["org.ofbiz.product.category.CategoryWorker"].getRelatedCategoriesRet(request, "subCatLists1", subCat.productCategoryId, true)>
											    						...
											    						<ul class="maindropdown">
											      							<#list subCatLists1 as subCat1>
											          							<li class="subcat" style="position:relative"><a href="${Static["org.ofbiz.product.category.CatalogUrlServlet"].makeCatalogUrl(request, "",subCat1.productCategoryId, subCat.productCategoryId,CategoryListSub2.productCategoryId)}?CURRENT_CATALOG_ID=${currentCatalogId}">${subCat1.categoryName}</a>											          							
											          				<#assign subCatLists2 = Static["org.ofbiz.product.category.CategoryWorker"].getRelatedCategoriesRet(request, "subCatLists2", subCat1.productCategoryId, true)>
											    						...
											    						<ul class="maindropdown"> 
											      							<#list subCatLists2 as subCat2>
											          							<li class="subcat" style="position:relative;"><a href="${Static["org.ofbiz.product.category.CatalogUrlServlet"].makeCatalogUrl(request, "", subCat2.productCategoryId, subCat1.productCategoryId,subCat.productCategoryId,CategoryListSub2.productCategoryId)}?CURRENT_CATALOG_ID=${currentCatalogId}">${subCat2.categoryName}</a></li>
											          						</#list>
											          					</ul>
											          					</#if>
