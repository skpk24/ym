...
allFavouriteLists = delegator.findList("ShoppingList", condition, null, ["listName"], null, false);
favouriteLists = EntityUtil.filterByAnd(allFavouriteLists, [parentShoppingListId : null]);
context.allFavouriteLists = allFavouriteLists;
context.favouriteLists = favouriteLists;
// get all favouriteListsTypes
favouriteListsTypes = delegator.findList("ShoppingListType", null, null, ["description"], null, true);
context.favouriteListsTypes = favouriteListsTypes;
...
/*if (!shoppingListId) {
   firstList = EntityUtil.getFirst(favouriteLists);
   if (firstList) {
