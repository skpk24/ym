     ...
     <table class="basic-table hover-bar" cellspacing='1'>
        ...
        <#if requestAttributes.creditcardwindowlist?exists && requestAttributes.creditcardwindowlist?has_content>
           <#assign creditcardwindowlist=requestAttributes.creditcardwindowlist/>
           <script>
           ...
           function partywindow(partyId){
	            	window.open("<@ofbizUrl>cutomerwindow</@ofbizUrl>?partyId="+partyId, "", "width=650,height=400,status=no,scrollbars=yes");}
                      ...
                      <#list creditcardwindowlist as dashBord>
                           <tr>
                            <td>
        ...
        <tr>
          <td> Total Credit Card Amount</td>
          <td colspan="2"> </td>
          <td >${requestAttributes.totalcreditcard?if_exists} </td>
