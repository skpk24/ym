...
<#--div class="screenlet">
    ...
    <div class="screenlet-body">
		<form name="stockReportform" method="post" action="<@ofbizUrl>stockInHandCSV</@ofbizUrl>">
				...
				<#-- <tr>
					...
					<td> 
						...
						<input type='text' size='25' class='inputBox' name='minDate'  action="javascript:chooseValidate('this');" onkeydown="chooseValidate(this);"/>
							<a href="javascript:call_cal(document.stockReportform.minDate,'');"><img src='/images/cal.gif' width='16' height='16' border='0' alt='Calendar'/></a>
					</td>
				</tr>-->
				<tr>
					...
					<td>
						<input type='text' size='25' class='inputBox' name='maxDate'  action="javascript:chooseValidate('this');" onkeydown="chooseValidate(this);" onClick="chooseValidate(this);"/>
							<a href="javascript:call_cal(document.stockReportform.maxDate,'');"><img src='/images/cal.gif' width='16' height='16' border='0' alt='Calendar'/></a>
					</td>
				</tr>
				<tr><td><span class="label">Category Name</span></td>
                       <td> <@htmlTemplate.lookupField formName="stockReportform" name="productCategoryIdTo" id="productCategoryIdTo" fieldFormName="LookupProductCategory"/></td>
				<tr><td> <span class="label">${uiLabelMap.ProductProductId}</span></td>
                     <td>   <@htmlTemplate.lookupField formName="stockReportform" name="productId" id="productId" fieldFormName="LookupProduct"/></td></tr>
			<tr>
					<td class="label">Brand Name: </td>
					
					 <td>   <@htmlTemplate.lookupField formName="stockReportform" name="brandName" id="brandName" fieldFormName="LookupBrand"/></td></tr>
