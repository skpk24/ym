...
public class DBCPConnectionFactory implements ConnectionFactoryInterface {
    ...
    protected static Map<String, ManagedDataSource> dsCache = new HashMap<String, ManagedDataSource>();//FastMap.newInstance();
    ...
    public Connection getConnection(GenericHelperInfo helperInfo, Element jdbcElement) throws SQLException, GenericEntityException {
        ...
        synchronized (DBCPConnectionFactory.class) {
           ...
           /*
            GenericObjectPool pool = new GenericObjectPool();
            pool.setTimeBetweenEvictionRunsMillis(3000);
            pool.setNumTestsPerEvictionRun(20);
            pool.setMinEvictableIdleTimeMillis(100);
            pool.setSoftMinEvictableIdleTimeMillis(100);
            pool.setMaxActive(maxSize);
            pool.setMaxIdle(1);
            pool.setMinIdle(0);
