...
public class IfCompare extends MethodOperation {
    ...
    protected List<MethodOperation> subOps = new ArrayList<MethodOperation>();//FastList.newInstance();
    ...
    public IfCompare(Element element, SimpleMethod simpleMethod) {
        ...
        if (elseElement != null) {
            elseSubOps = new ArrayList<MethodOperation>();//FastList.newInstance();
    ...
    public boolean exec(MethodContext methodContext) {
        ...
        List<Object> messages = new ArrayList<Object>();//FastList.newInstance();
    ...
    public List<MethodOperation> getAllSubOps() {
        List<MethodOperation> allSubOps = new ArrayList<MethodOperation>();//FastList.newInstance();
