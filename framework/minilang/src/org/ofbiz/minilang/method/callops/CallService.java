...
public class CallService extends MethodOperation {
    ...
    protected List<String> resultsToMap = new ArrayList<String>();//FastList.newInstance();

    /** A list of ResultToFieldDef objects */
    protected List<ResultToFieldDef> resultToField =  new ArrayList<ResultToFieldDef>();//FastList.newInstance();
  ...
  //  protected Map<FlexibleServletAccessor<Object>, ContextAccessor<Object>> resultToRequest = FastMap.newInstance();
    protected Map<FlexibleServletAccessor<Object>, ContextAccessor<Object>> resultToRequest = 
    		new HashMap<FlexibleServletAccessor<Object>, ContextAccessor<Object>>();
  ...
  //  protected Map<FlexibleServletAccessor<Object>, ContextAccessor<Object>> resultToSession = FastMap.newInstance();
   ...
   // protected Map<ContextAccessor<Object>, ContextAccessor<Object>> resultToResult = FastMap.newInstance();
    protected Map<ContextAccessor<Object>, ContextAccessor<Object>> resultToResult = 
    		new HashMap<ContextAccessor<Object>, ContextAccessor<Object>>();
