...
public class MapProcessor {
    ...
    String name;
    List<MakeInString> makeInStrings = new ArrayList<MakeInString>();//FastList.newInstance();
    List<SimpleMapProcess> simpleMapProcesses = new ArrayList<SimpleMapProcess>();//FastList.newInstance();
