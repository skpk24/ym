...
public class CachedClassLoader extends URLClassLoader {
    ...
    public static final Map<String, Class<?>> globalClassNameClassMap = new HashMap<String, Class<?>>();//FastMap.newInstance();
    public static final Set<String> globalBadClassNameSet = new HashSet<String>();//FastSet.newInstance();
    public static final Map<String, URL> globalResourceMap = new HashMap<String, URL>();//   FastMap.newInstance();
    public static final Set<String> globalBadResourceNameSet = new HashSet<String>();//FastSet.newInstance();

    private String contextName;
    protected final Map<String, Class<?>> localClassNameClassMap = new HashMap<String, Class<?>>();//FastMap.newInstance();
    protected final Set<String> localBadClassNameSet = new HashSet<String>();//FastSet.newInstance();
    protected final Map<String, URL> localResourceMap = new HashMap<String, URL>();//FastMap.newInstance();
    protected final Set<String> localBadResourceNameSet = new HashSet<String>();//FastSet.newInstance();
