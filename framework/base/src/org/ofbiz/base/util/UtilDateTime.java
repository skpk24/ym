...
public class UtilDateTime {
    ...
    /**
     * returns a month number in a year for a Timestamp input
     *
     * @param stamp Timestamp date
     * @return A int containing the month number (jan = 0, dec = 11)
     */
    public static int monthNumber(Timestamp stamp) {
        Calendar tempCal = toCalendar(stamp, TimeZone.getDefault(), Locale.getDefault());
    ...
    public static int getDaysBetweenDates(Date startDate, Date endDate) {
		long diff = endDate.getTime() - startDate.getTime();
  		int days = (int) Math.floor(diff / MILLIS_IN_DAY);
     ...
     * @return
     */
    public static Date getParsedDate(String dateArg) {
    	return getParsedDate(dateArg,defaultDateFormat);
    }
     ...
     * @return
     */
    public static Date getParsedDate(String dateArg,String format) {
    	SimpleDateFormat sdf = new SimpleDateFormat(format);
    	Date parsedDate = null;
        try {
        	parsedDate = sdf.parse(dateArg);
        } catch (Exception e) {
   	    	 //System.out.println(" Error in parsing date"+e.toString());
    	}
     ...
     * @return
     */
    public static String getFormattedDate(Date dateArg) {
    	return getFormattedDate(dateArg,defaultDateFormat);
     ...
     * @return
     */
    public static String getFormattedDate(Date dateArg, String format) {
    	SimpleDateFormat sdf = new SimpleDateFormat(format);
    	String formattedDate = null;
        try {
        	formattedDate = sdf.format(dateArg);
        } catch (Exception e) {
   	    	 //System.out.println(" Error in gettting the formatted date"+e.toString());
    	}
