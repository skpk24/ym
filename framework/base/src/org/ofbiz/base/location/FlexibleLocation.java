...
public class FlexibleLocation {
    ...
    protected static Map<String, LocationResolver> locationResolvers = new HashMap<String, LocationResolver>();//FastMap.newInstance();

    protected static Map<String, String> defaultResolvers = new HashMap<String, String>();//FastMap.newInstance();
