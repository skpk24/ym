...
public class ServerHitBin {
        ...
        if (binList == null) {
            synchronized (ServerHitBin.class) {
                ...
                if (binList == null) {
                    ...
                    binList = new ArrayList<ServerHitBin>();
                    switch (type) {
                    case REQUEST:
    ...
    public static Map<String, List<ServerHitBin>> requestHistory = new HashMap<String, List<ServerHitBin>>();//FastMap.newInstance();
    public static Map<String, List<ServerHitBin>> eventHistory = new HashMap<String, List<ServerHitBin>>();//FastMap.newInstance();
    public static Map<String, List<ServerHitBin>> viewHistory =new HashMap<String, List<ServerHitBin>>();// FastMap.newInstance();
    public static Map<String, List<ServerHitBin>> entityHistory =new HashMap<String, List<ServerHitBin>>();// FastMap.newInstance();
    public static Map<String, List<ServerHitBin>> serviceHistory = new HashMap<String, List<ServerHitBin>>();//FastMap.newInstance();

    // these Maps contain ServerHitBin objects by id
    public static Map<String, ServerHitBin> requestSinceStarted =new HashMap<String, ServerHitBin>();// FastMap.newInstance();
    public static Map<String, ServerHitBin> eventSinceStarted = new HashMap<String, ServerHitBin>();//FastMap.newInstance();
    public static Map<String, ServerHitBin> viewSinceStarted = new HashMap<String, ServerHitBin>();//FastMap.nwInstance();
    public static Map<String, ServerHitBin> entitySinceStarted = new HashMap<String, ServerHitBin>();//FastMap.newInstance();
    public static Map<String, ServerHitBin> serviceSinceStarted = new HashMap<String, ServerHitBin>();//FastMap.newInstance();
