...
import org.ofbiz.webapp.stats.ClickStreamAnalysis;
...
//                    String trafficAnalysis = UtilProperties.getPropertyValue("NichesuiteBi.properties", "traffic.analysis.enabled");
//                    if (!UtilValidate.isEmpty(trafficAnalysis)) {
//                    	  ClickStreamAnalysis.saveBIHit(webappName, request, requestStartTime,  System.currentTimeMillis() - requestStartTime, userLogin, delegator);
//                    }
