...
public class ConfigXMLReader {
    ...
    public static class ControllerConfig {
       ...
       // private List<URL> includes = FastList.newInstance();
        ...
        private Map<String, Event> firstVisitEventList = new HashMap<String, ConfigXMLReader.Event>();//FastMap.newInstance();
        private Map<String, Event> preprocessorEventList =new HashMap<String, ConfigXMLReader.Event>();// FastMap.newInstance();
        private Map<String, Event> postprocessorEventList =new HashMap<String, ConfigXMLReader.Event>(); //FastMap.newInstance();
        private Map<String, Event> afterLoginEventList = new HashMap<String, ConfigXMLReader.Event>();//FastMap.newInstance();
        private Map<String, Event> beforeLogoutEventList = new HashMap<String, ConfigXMLReader.Event>();//FastMap.newInstance();

        private Map<String, String> eventHandlerMap = new HashMap<String, String>();//FastMap.newInstance();
        private Map<String, String> viewHandlerMap =new HashMap<String, String>(); //FastMap.newInstance();

        private Map<String, RequestMap> requestMapMap = new HashMap<String, ConfigXMLReader.RequestMap>();//FastMap.newInstance();
        private Map<String, ViewMap> viewMapMap = new HashMap<String, ConfigXMLReader.ViewMap>();//FastMap.newInstance();
    ...
    public static class RequestMap {
        ...
        public Map<String, RequestResponse> requestResponseMap =new HashMap<String, ConfigXMLReader.RequestResponse>();// FastMap.newInstance();
    ...
    public static class RequestResponse {
        ...
        public Map<String, String> redirectParameterMap = new HashMap<String, String>();//FastMap.newInstance();
        public Map<String, String> redirectParameterValueMap = new HashMap<String, String>();//FastMap.newInstance();
