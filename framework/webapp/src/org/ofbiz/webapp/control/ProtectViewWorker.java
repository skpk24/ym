...
public class ProtectViewWorker {
    ...
    private static final HashMap<String, Long> hitsByViewAccessed = new HashMap<String, Long>();//FastMap.newInstance();
    private static final HashMap<String, Long> durationByViewAccessed = new HashMap<String, Long>();//FastMap.newInstance();
