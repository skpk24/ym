...
public class ServiceDispatcher {
    ...
    protected static Map<String, ServiceDispatcher> dispatchers = new HashMap<String, ServiceDispatcher>();//FastMap.newInstance();
    ...
    protected ServiceDispatcher(Delegator delegator, boolean enableJM, boolean enableJMS, boolean enableSvcs) {
        ...
        this.localContext = new HashMap<String, DispatchContext>();//FastMap.newInstance();
        this.callbacks = new HashMap<String, List<GenericServiceCallback>>();//FastMap.newInstance();
    ...
    public synchronized void registerCallback(String serviceName, GenericServiceCallback cb) {
        ...
        if (callBackList == null) {
        	...
        	callBackList = new ArrayList<GenericServiceCallback>();
        }
        callBackList.add(cb);
    ...
    public Map<String, Object> runSync(String localName, ModelService modelService, Map<String, ? extends Object> params, boolean validateOut) throws ServiceAuthException, ServiceValidationException, GenericServiceException {
        ...
        try {
            ...
            try {
                    ...
                    if (beganTrans) {
                        ...
                        if (errMsg != null && errMsg.toUpperCase().indexOf("DEADLOCK") >= 0) {
                            ...
                            if (!beganTrans) {
                                ...
                                result = new HashMap<String, Object>();//FastMap.newInstance();
                                isFailure = false;
                                isError = false;
                ...
                ecaContext = new HashMap<String, Object>();//FastMap.newInstance();
