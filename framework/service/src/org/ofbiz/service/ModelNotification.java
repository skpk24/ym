...
public class ModelNotification {
    ...
    public Map<String, Object> buildContext(Map<String, ? extends Object> context, Map<String, Object> result, ModelService model) throws GenericServiceException {
        ...
        // template context
        Map<String, Object> notifyContext = new HashMap<String, Object>();//FastMap.newInstance();
        Map<String, Object> bodyParams = new HashMap<String, Object>();//FastMap.newInstance();
