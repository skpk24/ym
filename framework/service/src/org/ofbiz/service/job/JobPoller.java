...
public class JobPoller implements Runnable {
    ...
    public JobPoller(JobManager jm, boolean enabled) {
        this.jm = jm;
        this.run = new ArrayList<Job>();//FastList.newInstance();
    ...
    public List<Map<String, Object>> getPoolState() {
        List<Map<String, Object>> stateList = new ArrayList<Map<String,Object>>();//FastList.newInstance();
        for (JobInvoker invoker: this.pool) {
            Map<String, Object> stateMap =new HashMap<String, Object>();// FastMap.newInstance();
    ...
    private List<JobInvoker> createThreadPool() {
        List<JobInvoker> threadPool = new ArrayList<JobInvoker>();//FastList.newInstance();
