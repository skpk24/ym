...
public class JobManager {
    ...
    public static Map<String, JobManager> registeredManagers =new HashMap<String, JobManager>();// FastMap.newInstance();
    ...
    public synchronized List<Job> poll() {
        List<Job> poll = new ArrayList<Job>();//FastList.newInstance();
        ...
        while (!pollDone) {
            ...
            synchronized (this) {
                ...
                try {
                    ...
                    List<Job> localPoll = new ArrayList<Job>();//FastList.newInstance();
