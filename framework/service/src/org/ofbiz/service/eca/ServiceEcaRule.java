...
public class ServiceEcaRule implements java.io.Serializable {
    ...
    protected List<ServiceEcaCondition> conditions = new ArrayList<ServiceEcaCondition>();
    protected List<Object> actionsAndSets =  new ArrayList<Object>();
    ...
    public List<ServiceEcaAction> getEcaActionList() {
      //  List<ServiceEcaAction> actionList = FastList.newInstance();
    	List<ServiceEcaAction> actionList = new ArrayList<ServiceEcaAction>();
    ...
    public List<ServiceEcaCondition> getEcaConditionList() {
    	...
    	List<ServiceEcaCondition> condList = new ArrayList<ServiceEcaCondition>();
