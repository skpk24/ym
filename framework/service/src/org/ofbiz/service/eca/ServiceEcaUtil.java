...
public class ServiceEcaUtil {
    ...
    public static Map<String, Map<String, List<ServiceEcaRule>>> ecaCache = new HashMap<String, Map<String,List<ServiceEcaRule>>>();//FastMap.newInstance();
    ...
    public static void addEcaDefinitions(ResourceHandler handler) {
        ...
        for (Element e: UtilXml.childElementList(rootElement, "eca")) {
            ...
            if (eventMap == null) {
                eventMap = new HashMap<String, List<ServiceEcaRule>>();//FastMap.newInstance();
              //  rules = FastList.newInstance();
                rules = new ArrayList<ServiceEcaRule>();
        ...
        if (eventMap != null) {
            if (event != null) {
               ...
               // List<ServiceEcaRule> rules = FastList.newInstance();
            	List<ServiceEcaRule> rules = new ArrayList<ServiceEcaRule>();
