...
public class JmsListenerFactory implements Runnable {
    ...
    protected static Map<String, GenericMessageListener> listeners =new HashMap<String, GenericMessageListener>();// FastMap.newInstance();
    protected static Map<String, Element> servers = new HashMap<String, Element>();//FastMap.newInstance();
