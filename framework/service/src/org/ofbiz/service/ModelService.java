...
public class ModelService extends AbstractMap<String, Object> implements Serializable {
    ...
    private static final Map<String, Field> MODEL_SERVICE_FIELD_MAP = new HashMap<String, Field>();//FastMap.newInstance();
    static {
   ...
   // public List<ModelPermGroup> permissionGroups = FastList.newInstance();
    public List<ModelPermGroup> permissionGroups = new ArrayList<ModelPermGroup>();

    /** List of email-notifications for this service */
    //public List<ModelNotification> notifications = FastList.newInstance();
    public List<ModelNotification> notifications = new ArrayList<ModelNotification>();
    ...
    protected Map<String, ModelParam> contextInfo = new HashMap<String, ModelParam>();//FastMap.newInstance();
    ...
    protected List<ModelParam> contextParamList = new ArrayList<ModelParam>();
    ...
    */
    ...
    public void validate(Map<String, Object> context, String mode, Locale locale) throws ServiceValidationException {
        Map<String, String> requiredInfo = new HashMap<String, String>();//FastMap.newInstance();
        Map<String, String> optionalInfo = new HashMap<String, String>();//FastMap.newInstance();
        ...
        // get the test values
        Map<String, Object> requiredTest = new HashMap<String, Object>();//FastMap.newInstance();
        Map<String, Object> optionalTest =new HashMap<String, Object>();// FastMap.newInstance();

        if (context == null) context =new HashMap<String, Object>();// FastMap.newInstance();
        requiredTest.putAll(context);

        /*List<String> requiredButNull = FastList.newInstance();
        List<String> keyList = FastList.newInstance();*/
        List<String> requiredButNull = new ArrayList<String>();
        ...
        if (requiredButNull.size() > 0) {
        	...
        	List<String> missingMsg = new ArrayList<String>();
    ...
    public static void validate(Map<String, String> info, Map<String, ? extends Object> test, boolean reverse, ModelService model, String mode, Locale locale) throws ServiceValidationException {
        ...
        if (reverse && !testSet.containsAll(keySet)) {
            ...
            List<String> missingCopy = new ArrayList<String>();
        ...
        if (!keySet.containsAll(testSet)) {
           ...
           // List<String> extraMsgs = FastList.newInstance();
            ...
            List<String> extraCopy = new ArrayList<String>();
        ...
        List<String> typeFailMsgs = new ArrayList<String>();
    ...
    public Map<String, Object> makeValid(Map<String, ? extends Object> source, String mode, boolean includeInternal, List<Object> errorMessages, TimeZone timeZone, Locale locale) {
        Map<String, Object> target = new HashMap<String, Object>();//FastMap.newInstance();
    ...
    private Map<String, Object> makePrefixMap(Map<String, ? extends Object> source, ModelParam param) {
        Map<String, Object> paramMap =new HashMap<String, Object>();//FastMap.newInstance();
    ...
    public List<ModelParam> getModelParamList() {
    	...
    	List<ModelParam> newList = new ArrayList<ModelParam>();
    ...
    public List<ModelParam> getInModelParamList() {
      //  List<ModelParam> inList = FastList.newInstance();
    	List<ModelParam> inList = new ArrayList<ModelParam>();
        for (ModelParam modelParam: this.contextParamList) {
            // don't include OUT parameters in this list, only IN and INOUT
            if ("OUT".equals(modelParam.mode)) continue;
