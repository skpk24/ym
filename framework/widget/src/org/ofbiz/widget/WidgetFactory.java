...
public class WidgetFactory {
    ...
    protected static final Map<String, Constructor<? extends ModelScreenWidget>> screenWidgets = new HashMap<String, Constructor<? extends ModelScreenWidget>>();//FastMap.newInstance();
