...
<#if (errorMessage?has_content || errorMessageList?has_content)>
  ...
  <div id="content-messages" class="content-messages errorMessage" style="width:900px;" onclick="document.getElementById('content-messages').parentNode.removeChild(this)">
...
<#if (eventMessage?has_content || eventMessageList?has_content)>
 <span style="color:#ff0000 !important;">
  <div id="content-messages" class="content-messages eventMessage" onclick="document.getElementById('content-messages').parentNode.removeChild(this)">
    ...
    <#if eventMessage?has_content>
      <p class="messagep">${eventMessage}</p>
    </#if>
    <#if eventMessageList?has_content>
      <#list eventMessageList as eventMsg>
        <p class="messagep">${eventMsg}</p>
      </#list>
    </#if>
  </div>
   </span>
