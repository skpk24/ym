...
public class JsLanguageFileMappingCreator {
    ...
    public static Map<String, Object> createJsLanguageFileMapping(DispatchContext ctx, Map<String, ?> context) {
        ...
        Map<String, Object> jQueryLocaleFile = new HashMap<String, Object>();//FastMap.newInstance();
        Map<String, String> dateJsLocaleFile = new HashMap<String, String>(); //FastMap.newInstance();
        Map<String, String> validationLocaleFile = new HashMap<String, String>(); //FastMap.newInstance();
        Map<String, String> dateTimePickerLocaleFile = new HashMap<String, String>(); //FastMap.newInstance();
