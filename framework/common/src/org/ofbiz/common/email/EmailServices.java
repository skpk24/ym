...
public class EmailServices {
    ...
    public static Map<String, Object> sendMail(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        try {
           ...
           // List<SMTPAddressFailedException> failedAddresses = FastList.newInstance();
            List<SMTPAddressFailedException> failedAddresses = new ArrayList<SMTPAddressFailedException>();
    ...
    public static Map<String, Object> sendMailFromScreen(DispatchContext dctx, Map<String, ? extends Object> rServiceContext) {
       ...
       // List<String> attachmentNameList = FastList.newInstance();
        List<String> xslfoAttachScreenLocationList = new ArrayList<String>();
        ...
        if (UtilValidate.isNotEmpty(xslfoAttachScreenLocationList)) {
          //  List<Map<String, ? extends Object>> bodyParts = FastList.newInstance();
            List<Map<String, ? extends Object>> bodyParts = new ArrayList<Map<String, ? extends Object>>();
            if (bodyText != null) {
