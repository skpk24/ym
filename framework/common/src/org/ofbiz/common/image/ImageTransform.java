...
public class ImageTransform {
    ...
    public static  Map<String, Object> getXMLValue(String fileFullPath, Locale locale)
        ...
        Document document;
        Element rootElt;
        Map<String, Map<String, String>> valueMap = new HashMap<String, Map<String,String>>();//FastMap.newInstance();
        Map<String, Object> result = new HashMap<String, Object>();//FastMap.newInstance();
        ...
        for (Element currentElt : children) {
            Map<String, String> eltMap = new HashMap<String, String>();//FastMap.newInstance();
            List<? extends Element> children2 = UtilXml.childElementList(currentElt);
            if (children2.size() > 0) {
                Map<String, String> childMap =  new HashMap<String, String>();//FastMap.newInstance();
