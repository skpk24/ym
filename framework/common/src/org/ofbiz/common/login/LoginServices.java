                ...
                if (userLogin != null) {
                    ...
                    if (UtilValidate.isEmpty(userLogin.getString("enabled")) || "Y".equals(userLogin.getString("enabled")) ||
                        ...
                        if (disabledDateTime != null) {
                        	String disabledDateTime1 = sdf.format(disabledDateTime);
                            messageMap = UtilMisc.<String, Object>toMap("disabledDateTime", disabledDateTime1);
                        ...
                        if (loginDisableMinutes > 0 && reEnableTime != null) {
                        	...
                        	String reEnableTime1 = sdf.format(reEnableTime);
                            messageMap = UtilMisc.<String, Object>toMap("reEnableTime", reEnableTime1);
