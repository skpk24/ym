...
public class EntityEcaRule implements java.io.Serializable {
    ...
    protected List<EntityEcaCondition> conditions = new ArrayList<EntityEcaCondition>();//FastList.newInstance();
    protected List<Object> actionsAndSets = new ArrayList<Object>();//FastList.newInstance();
