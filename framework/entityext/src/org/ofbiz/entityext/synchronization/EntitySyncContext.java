...
public class EntitySyncContext {
    ...
    public void createInitialHistory() throws SyncDataErrorException, SyncServiceErrorException {
        ...
        try {
            Map<String, Object> initialHistoryRes = dispatcher.runSync("createEntitySyncHistory", UtilMisc.toMap("posTerminalId",posTerminalId,"entitySyncId", entitySyncId, "runStatusId", "ESR_RUNNING", "beginningSynchTime", this.currentRunStartTime, "lastCandidateEndTime", this.currentRunEndTime, "userLogin", userLogin));
