...
jQuery(document).ready(function(){
    ...
    function submit() {
    	  var billToContactMechId= $("#billToContactMechId").val();
    	  var shipToContactMechIdInBillingForm= $("#shipToContactMechIdInBillingForm").val();
    	  var paymentMethodId= $("#paymentMethodId").val();
    	  var paymentMethodTypeId = $("#checkOutPaymentId").val();
    	  var billToPartyId= $("#billToPartyId").val();
    	  var expireDate= $("#expireDate").val();
    	  var billToPhoneContactMechId= $("#billToPhoneContactMechId").val();
    	  var billToName= $("#billToName").val();
    	  var billToAttnName= $("#billToAttnName").val();
    	  var keepAddressBook= $("#keepAddressBook").val();
    	  var setDefaultBilling= $("#setDefaultBilling").val();
    	  var productStoreId= $("#productStoreId").val();
    	  var billToAddress1= $("#billToAddress1").val();
    	  var billToAddress2= $("#billToAddress2").val();
    	  var billToCity= $("#billToCity").val();
    	  var billToPostalCode= $("#billToPostalCode").val();
    	  var billToCountryGeoId= $("#billToCountryGeoId").val();
    	  var billToStateProvinceGeoId= $("#billToStateProvinceGeoId").val();
    	  
  //alert("billToContactMechId:::"+billToContactMechId+"shipToContactMechIdInBillingForm"+shipToContactMechIdInBillingForm+"paymentMethodId"+paymentMethodId);
  //alert("paymentMethodTypeId:::"+paymentMethodTypeId+"billToPartyId"+billToPartyId+"expireDate"+expireDate+"billToPhoneContactMechId"+billToPhoneContactMechId);
 // alert("billToName:::"+billToName+"billToAttnName"+billToAttnName+"keepAddressBook"+keepAddressBook+"setDefaultBilling"+setDefaultBilling);
 // alert("productStoreId:::"+productStoreId+"billToAddress1"+billToAddress1+"billToAddress2"+billToAddress2+"billToCity"+billToCity);
 // alert("billToPostalCode:::"+billToPostalCode+"billToCountryGeoId"+billToCountryGeoId+"billToStateProvinceGeoId"+billToStateProvinceGeoId);
  
  var data=jQuery('#billingForm').serialize();
  //alert("DATA::"+data);
...
function processBillingAndPaymentCOD() {
    var result = false;
    jQuery.ajax({
        url: 'createUpdateBillingAndPayment',
        type: 'POST',
        ...
        success: function(json) {
        	...
        	alert("billToPhoneContactMechId::::"+json.billToPhoneContactMechId);
